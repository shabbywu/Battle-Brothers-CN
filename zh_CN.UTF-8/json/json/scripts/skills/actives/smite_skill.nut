[
    ...
    },
    {
        ...
        "translation": "，持续 1 回合",
        "stage": 5,
        "context": "this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + ' has staggered ' + this.Const.UI.getColorizedEntityName(_targetTile.getEntity()) + ' for one turn')"
    },
    {
        "ID": 293420430,
