[
    ...
    },
    {
        ...
        "translation": "渔夫",
        "stage": 1,
        "context": "this.m.Name = 'Fisherman'"
    },
    {
        "ID": 293420962,
        "key": "With the fighting career going so poorly, %name% decided to retire from the field and return to fishing. He went missing at sea after an enormous storm wrecked the shorelines.",
        "original": "With the fighting career going so poorly, %name% decided to retire from the field and return to fishing. He went missing at sea after an enormous storm wrecked the shorelines.",
        "translation": "战斗生涯屡遭不顺，%name%决定退出战场，回归捕鱼。一场巨大的风暴席卷了海岸线后，他失踪了。",
        "stage": 1,
        "context": "this.m.BadEnding = 'With the fighting career going so poorly, %name% decided to retire from the field and return to fishing. He went missing at sea after an enormous storm wrecked the shorelines.'"
    },
    {
        "ID": 293420963,
        "key": "Fishermen are used to physical labor.",
        "original": "Fishermen are used to physical labor.",
        "translation": "渔夫习惯于体力劳动。",
        "stage": 5,
        "context": "this.m.BackgroundDescription = 'Fishermen are used to physical labor.'"
    },
    {
        "ID": 293420964,
    ...
    {
        "ID": 293420966,
        "key": "%name% retired from fighting and returned to his fishing ventures. A huge storm ran up the shores, destroying every skiff and drifter - except that wily fisherman's! The only boat afloat, %name%'s business boomed. He lives a comfortable life waking up to ",
        "original": "%name% retired from fighting and returned to his fishing ventures. A huge storm ran up the shores, destroying every skiff and drifter - except that wily fisherman's! The only boat afloat, %name%'s business boomed. He lives a comfortable life waking up to a nice beachfront view every morning.",
        "translation": "%name%从战场上退役，回到了他的渔业事业中。一场巨大的风暴席卷海岸，摧毁了每一艘小艇和舢板 —— 除了这位狡猾渔夫的！坐拥唯一幸存的船只，%name%的渔业事业得以迅速繁荣。他每天早上醒来都能享受美丽的海滩景色，生活舒适惬意。",
        "stage": 1,
        "context": "this.m.GoodEnding = \"%name% retired from fighting and returned to his fishing ventures. A huge storm ran up the shores, destroying every skiff and drifter - except that wily fisherman's! The only boat afloat, %name%'s business boomed. He lives a comfortable life waking up to a nice beachfront view every morning.\""
    },
    {
        "key": "%name% retired from fighting and returned to his fishing ventures. A huge storm ran up the shores, destroying every skiff and drifter - except that wily fisherman's! The only boat afloat, %name%'s business boomed. He lives a comfortable life waking up to a nice beachfront view every morning.",
        "original": "%name% retired from fighting and returned to his fishing ventures. A huge storm ran up the shores, destroying every skiff and drifter - except that wily fisherman's! The only boat afloat, %name%'s business boomed. He lives a comfortable life waking up to a nice beachfront view every morning.",
        "translation": "",
        "context": "this.m.GoodEnding = \"%name% retired from fighting and returned to his fishing ventures. A huge storm ran up the shores, destroying every skiff and drifter - except that wily fisherman's! The only boat afloat, %name%'s business boomed. He lives a comfortable life waking up to a nice beachfront view every morning.\""
    },
