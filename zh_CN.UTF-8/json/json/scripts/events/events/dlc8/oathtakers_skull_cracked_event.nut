[
    {
        "ID": 293415537,
        "key": "I should have been an undertaker.",
        "original": "I should have been an undertaker.",
        "translation": "我本该成为一个接待员。",
        "stage": 1,
        "context": "Text = 'I should have been an undertaker.'"
    },
    {
        "ID": 293415538,
        "key": " is now Determined",
        "original": " is now Determined",
        "translation": "现在变得坚定了。",
        "stage": 1,
        "context": "text = _event.m.Oathtaker.getName() + ' is now Determined'"
    },
    {
        "ID": 293415539,
        "key": "Nice save.",
    ...
    },
    {
        ...
        "stage": 1,
        "context": "text = _event.m.Oathtaker.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + resolveBoost + '[/color] Resolve'"
    },
    {
        "ID": 293415542,
        "key": " gains Deathwish",
        "original": " gains Deathwish",
        "translation": "获得死亡之愿效果。",
        "stage": 1,
        "context": "text = bro.getName() + ' gains Deathwish'"
    },
    {
        "ID": 293415543,
        "key": "Had his faith in Young Anselm redoubled",
        "original": "Had his faith in Young Anselm redoubled",
        "translation": "他对年幼的安瑟姆的信任加倍了。",
        "stage": 1,
        "context": "_event.m.Oathtaker.improveMood(1.0, 'Had his faith in Young Anselm redoubled')"
    },
    {
        "ID": 293415544,
        "key": "]+1[/color] Resolve",
        ...
        "stage": 1,
        "context": "text = _event.m.Oathtaker.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+1[/color] Resolve'"
    },
    {
        "ID": 293415545,
        "key": "[/color] Resolve",
