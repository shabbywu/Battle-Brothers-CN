[
    {
        ...
        "translation": "[img]gfx/ui/events/event_05.png[/img]有几个兄弟来找你，看上去很着急。他们说%cultist%和%uneducated%坐在一起已经几个小时了。当你问他们担心什么时，他们提醒你那个邪教徒额头有伤疤，还会说些令人难以置信的怪事。是的。这些都是达库尔的要求，一个某人奉献的范例。你不明白这有什么不对。\n\n你去见那两人。%uneducated%抬头看着你，微笑着，说这个邪教徒有很多东西要教他。也许他确实有，但你知道并不是所有人都需要感受到达库尔的存在，如果强迫其降临到世界上，那将是对达库尔目的的误解。",
        "stage": 5,
        "context": "Text = \"[img]gfx/ui/events/event_05.png[/img]A few brothers come to you looking rather worried. They say %cultist% has been sitting with %uneducated% for a few hours now. When you ask what's the worry, they remind you that the cultist has a scarred forehead and speaks of incredibly strange things. Yeah. Those are the demands of Davkul, an example of one's committment. You do not understand what could possibly be wrong with that.\n\n You go and see the two men. %uneducated% looks up at you, smiling, and says the cultist actually has a lot to teach him. Perhaps he does, but you know Davkul's presence need not be felt in all, and if it desired being forced upon the world it would be a misapprehension of Davkul's purpose.\""
    },
    {
        "ID": 293414232,
        "key": "Show him the darkness.",
    ...
    },
    {
        ...
        "translation": "被剥夺了转化他人为邪教徒的机会，本将转化",
        "stage": 2,
        "context": "_event.m.Cultist.worsenMood(1.0, 'Was denied the chance to convert ' + _event.m.Uneducated.getName())"
    },
    {
        "ID": 293414235,
        "key": "[img]gfx/ui/events/event_05.png[/img]You nod and turn away. By next morning, %uneducated% is found with a fresh wound on his forehead, the blood of conversion and the price some must pay to devote themselves to Davkul. When you ask how he is doing, he onl",
        ...
        "translation": "[img]gfx/ui/events/event_05.png[/img]你点头，转身走开了。第二天早上，%uneducated%的额头上多了个新伤口，那是皈依达库尔所需付出的代价和奉献的鲜血。你问他感觉如何，他只说了几句话。%SPEECH_ON%达库尔即将降临。%SPEECH_OFF%摇着头，你纠正他。%SPEECH_ON%达库尔不是要降临。达库尔在*等待*我们所有人。%SPEECH_OFF%",
        "stage": 5,
        "context": "Text = '[img]gfx/ui/events/event_05.png[/img]You nod and turn away. By next morning, %uneducated% is found with a fresh wound on his forehead, the blood of conversion and the price some must pay to devote themselves to Davkul. When you ask how he is doing, he only says a few words.%SPEECH_ON%Davkul is coming.%SPEECH_OFF%Shaking your head, you correct him.%SPEECH_ON%Davkul is not coming. Davkul AWAITS us all.%SPEECH_OFF%'"
    },
    {
        "ID": 293414236,
        "key": "[img]gfx/ui/events/event_05.png[/img]You separate the two men, telling %uneducated% to go count some inventory. When he leaves, %cultist% sneers at you.%SPEECH_ON%Davkul awaits. You see him in your sleep. You see him in the nights. His darkness is coming.",
    ...
    {
        "ID": 293414242,
        "key": "Davkul does not want him.",
        "original": "Davkul does not want him.",
        "translation": "达库尔并不想要他。",
        "stage": 5,
