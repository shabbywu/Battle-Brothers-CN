[
    ...
    },
    {
        ...
        "stage": 1,
        "context": "text = 'You win [color=' + this.Const.UI.Color.PositiveEventValue + ']25[/color] Crowns'"
    },
    {
        "ID": 293416586,
        "key": "Let's roll again!",
        "original": "Let's roll again!",
        "translation": "再掷一次！",
        "stage": 1,
        "context": "Text = \"Let's roll again!\""
    },
    {
        "ID": 293416587,
        "key": "Has played a game of dice with you",
        "original": "Has played a game of dice with you",
        "translation": "和你玩了一场骰子游戏",
        "stage": 1,
        "context": "_event.m.Gambler.improveMood(1.0, 'Has played a game of dice with you')"
    },
    {
        "ID": 293416588,
        "key": "]25[/color] Crowns",
        "original": "]25[/color] Crowns",
    ...
    {
        "ID": 293416589,
        "key": "I have no time for this.",
        "original": "I have no time for this.",
        "translation": "我没有时间干这个。",
        "stage": 1,
        "context": "Text = 'I have no time for this.'"
    },
    {
        "ID": 293416590,
        "key": "[img]gfx/ui/events/event_62.png[/img]While relaxing after the day's walk, %gambler% comes up to you with a pair of dice and a cup in hand. He asks if you wish to have a little game. The rules are quite simple: you roll the dice from the cup, whoever has t",
        "original": "[img]gfx/ui/events/event_62.png[/img]While relaxing after the day's walk, %gambler% comes up to you with a pair of dice and a cup in hand. He asks if you wish to have a little game. The rules are quite simple: you roll the dice from the cup, whoever has the highest numbers wins. It's pure chance! The wager will be twenty-five crowns per dice roll.",
        "translation": "[img]gfx/ui/events/event_62.png[/img]走了一天的路之后，在休息的时候，%gambler% 手里拿着一副骰子和一个杯子走到了你的身边。 他问你想不想来玩一个小游戏。 规则非常简单：每个人摇一次骰子，点数高的人获胜。 这是一个好机会！每次的赌注是二十五克朗。",
        "stage": 1,
        "context": "Text = \"[img]gfx/ui/events/event_62.png[/img]While relaxing after the day's walk, %gambler% comes up to you with a pair of dice and a cup in hand. He asks if you wish to have a little game. The rules are quite simple: you roll the dice from the cup, whoever has the highest numbers wins. It's pure chance! The wager will be twenty-five crowns per dice roll.\""
    },
    {
        "ID": 293416591,
        "key": "You lose [color=",
        ...
        "stage": 1,
        "context": "text = 'You lose [color=' + this.Const.UI.Color.NegativeEventValue + ']25[/color] Crowns'"
    },
    {
        "ID": 293416592,
        "key": "[img]gfx/ui/events/event_62.png[/img]You roll the dice, landing a total of %playerdice%.\n\n%gambler% goes next, rolling a total of %gamblerdice%.\n\n{You won! The gambler claps his hands.%SPEECH_ON%Beginner's luck!%SPEECH_OFF%You cross your arms.%SPEECH_ON%I",
    ...
    {
        "ID": 293416594,
        "key": "I've had enough for today.",
        "original": "I've had enough for today.",
        "translation": "今天就到这吧。",
        "stage": 1,
        "context": "Text = \"I've had enough for today.\""
    },
    {
        "ID": 293416595,
        "key": "Let's play!",
        ...
        "translation": "那就来玩玩吧！",
        "stage": 1,
        "context": "Text = \"Let's play!\""
    },
    {
        "key": "[img]gfx/ui/events/event_62.png[/img]While relaxing after the day's walk, %gambler% comes up to you with a pair of dice and a cup in hand. He asks if you wish to have a little game. The rules are quite simple: you roll the dice from the cup, whoever has the highest numbers wins. It's pure chance! The wager will be twenty-five crowns per dice roll.",
        "original": "[img]gfx/ui/events/event_62.png[/img]While relaxing after the day's walk, %gambler% comes up to you with a pair of dice and a cup in hand. He asks if you wish to have a little game. The rules are quite simple: you roll the dice from the cup, whoever has the highest numbers wins. It's pure chance! The wager will be twenty-five crowns per dice roll.",
        "translation": "",
        "context": "Text = \"[img]gfx/ui/events/event_62.png[/img]While relaxing after the day's walk, %gambler% comes up to you with a pair of dice and a cup in hand. He asks if you wish to have a little game. The rules are quite simple: you roll the dice from the cup, whoever has the highest numbers wins. It's pure chance! The wager will be twenty-five crowns per dice roll.\""
    },
