[
    {
        "ID": 293416495,
        "key": "Everything in order here.",
        "original": "Everything in order here.",
        "translation": "这里一切都很正常。",
        "stage": 1,
        "context": "Text = 'Everything in order here.'"
    },
    {
        "ID": 293416496,
        "key": "During camp...",
    ...
    {
        "ID": 293416497,
        "key": "[img]gfx/ui/events/event_05.png[/img]%SPEECH_ON%For the last time, no, I won't buy a rat.%SPEECH_OFF%You see %ratcatcher% the ratcatcher turn a corner with the skeevy peddler %peddler% on his heels. The salesman throws another pitch.%SPEECH_ON%'Course you",
