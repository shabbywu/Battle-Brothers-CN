[
  {
    ...
    "stage": 1,
    "context": "_event.m.Apprentice.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + meleeSkill + '[/color] Melee Skill'"
  },
  {
    "ID": 293412561,
    "key": "[/color] Resolve",
    ...
    "stage": 1,
    "context": "_event.m.Apprentice.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + resolve + '[/color] Resolve'"
  },
  {
    "ID": 293412562,
    "key": " gains [color=",
    ...
    "stage": 1,
    "context": "_event.m.Apprentice.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + hitpoints + '[/color] Hitpoints'"
  },
  {
    "ID": 293412563,
  ...
  {
    "ID": 293412564,
    "key": "[img]gfx/ui/events/event_05.png[/img]The apprentice %apprentice% has apparently become a ward to %teacher%. While the swordmaster is long in the tooth, he seems quite eager to help the young man become a better fighter. The apprentice uses a real sword, t",
    ...
    "translation": "[img]gfx/ui/events/event_05.png[/img]学徒 %apprentice% 似乎已经成为 %teacher% 的老人看护员。虽然这位剑术大师年事已高，但他似乎很想帮助这位年轻人成为一名更好的战士。 学徒用的是真剑，剑术大师用的是木剑。 剑术大师正是在这种武器的巨大差距下，展示如何有效地走位，发现弱点和避开危险。\n\n甚至在他年老的时候，这个人还在不停地闪转腾挪，使学徒根本打不动他。 一个巧妙的假动作，剑术大师看起来要被击中了，因为他离学徒很近，几乎要踩到脚了。 当学徒向后倾斜以给自己空间时，他的脚步乱了。 突然的拌蒜导致学员摔倒在地，他抬头发现一把木剑已经戳到了他的脖子。\n\n你发现这小子拍拍自己身上的泥土，现在至少能站起来继续拍泥土了。 我们只能说他这次小有提升吧。",
    "stage": 1
  },
  {
    "ID": 293412565,
  ...
  },
  {
    ...
    "stage": 1,
    "context": "_event.m.Apprentice.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + meleeDefense + '[/color] Melee Defense'"
  },
  {
    "ID": 293412567,
    ...
    "stage": 1,
    "context": "_event.m.Apprentice.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + stamina + '[/color] Max Fatigue'"
  },
  {
    "ID": 293412568,
    "key": "Well done!",
  ...
  },
  {
    ...
    "stage": 1,
    "context": "_event.m.Apprentice.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + initiative + '[/color] Initiative'"
  },
  {
    "ID": 293412570,
    "key": "Has taught ",
    ...
    "translation": "教授了",
    "stage": 1,
    "context": "'Has taught ' + _event.m.Apprentice.getName() + ' something'"
  },
  {
    "ID": 293412571,
    "key": " something",
  ...
  {
    "ID": 293412572,
    "key": "[img]gfx/ui/events/event_05.png[/img]A couple of times now you've caught %apprentice% watching %teacher% from a distance. The young apprentice seems rather enraptured by the hedge knight's brute violence. After a few days, the knight relents, asking the l",
    ...
    "translation": "[img]gfx/ui/events/event_05.png[/img]有几次你发现 %apprentice% 在远处观望 %teacher%。 年轻的学徒似乎被雇佣骑士的暴力美学折服了。 过了几天，骑士改变了主意，让小伙子过来和他聊聊天。 你不知道他们在说什么，但现在你已经注意到他们一直在一起训练了。 雇佣骑士可不是一个慈祥的教官。 他经常暴打那个男孩，使他坚强起来。 起初，学徒在每次训练前都会退缩，但现在你可以看到，面对如此巨大的逆境，他表现出了更强的决心。 雇佣骑士也在向他传授如何快速有效地杀人。 在你无意中听到的这些谈话中，很少有人提及防御方面的内容，但是谁需要防御一个被杀死的对手呢？",
    "stage": 1
  },
  {
    "ID": 293412573,
  ...
  {
    "ID": 293412574,
    "key": "[img]gfx/ui/events/event_05.png[/img]It appears as though %teacher% the ol' sellsword has a little bird following him around: young %apprentice%. Now in the company of mercenaries, the apprentice must want to learn from those with plenty of experience on ",
    ...
    "translation": "[img]gfx/ui/events/event_05.png[/img]看起来好像 %teacher% 这个老佣兵有一只跟着他的小鸟：年轻的 %apprentice%。现在，在这个雇佣兵组成的团队，学徒必须要向那些有丰富经验的人学习，赚取血汗钱。 当他们训练的时候，你会注意到佣兵把大部分的重点放在体能训练上。 比你的对手跑得快，比他更持久，就像把利刃刺穿他的大脑一样重要。 这个认真的小伙子似乎越来越健壮了，获得了一些前所未有的活力。",
    "stage": 1
  },
  {
    "ID": 293412575,
