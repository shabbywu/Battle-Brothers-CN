[
  ...
  },
  {
    ...
    "stage": 1,
    "context": "_event.m.Thief.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + initiative + '[/color] Initiative'"
  },
  {
    "ID": 293412978,
    "key": " suffers ",
    ...
    "translation": " 遭受 ",
    "stage": 5,
    "context": "_event.m.Butcher.getName() + ' suffers ' + injury.getNameOnly()"
  },
  {
    "ID": 293412979,
    "key": "Easy as it gets.",
  ...
  },
  {
    ...
    "stage": 1,
    "context": "_event.m.Butcher.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+3[/color] Resolve'"
  },
  {
    "ID": 293412995,
