[
  ...
  },
  {
    ...
    "translation": "%terrainImage%{你选了 %randombrother% 去试试，看看他能不能胜过那牲口。 比赛的规则看谁第一个到一颗苹果树那儿去，但在你能为你的佣兵开始喝彩之前，马就完全打败了他。 它到了终点线，并且开始为了吃苹果而摆弄树枝。 战队都沉默地坐着，但当 %randombrother% 以隔得很远的最后一名的身份冲过终点线的时候，他们都高兴地放声大笑，就好像他赢下了王国最好的妓院的钥匙。 马的主人笑了。%SPEECH_ON%别为难自己，好心的先生。 快乐是偶然的。%SPEECH_OFF%看起来的确是那个人在精彩比赛中的努力使你的团队感到快乐。} ",
    "stage": 1
  },
  {
    "key": " suffers ",
