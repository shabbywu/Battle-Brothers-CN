[
  ...
  {
    "ID": 293414328,
    "key": "All sorts of strange in these wastes.",
    "original": "All sorts of strange in these wastes.",
    "translation": "这片荒地上全是奇怪的东西。",
    "stage": 1,
    "context": "Text = 'All sorts of strange in these wastes.'"
  },
  {
    "ID": 293414329,
    "key": "[img]gfx/ui/events/event_76.png[/img]{While camping in the northern wastes, a silhouette approaches, a flat black whose appearance was seemingly cut out of the thin air itself. As it nears, an orange glow blossoms from a horn of fire. The company draw the",
    ...
    "translation": "[img]gfx/ui/events/event_76.png[/img]{当我们在北部荒原宿营的时候，一个轮廓出现了，一个扁平的黑色物体，它的外形似乎是从稀薄的空气中切割出来的。 当它接近时，橙色的光芒从一个火焰之角中绽放。 战团拔出他们的武器，为应对可能出现的黑影或者虚惊一场？ 什么“东西”穿越了这么荒凉的土地？ 但你发现他只是一个秃头红鼻子的老人。 如果能用雪把人从花岗岩上雕刻出来，那就是他的模样。 那个陌生人穿过营地，同伙们都转向他大喊大叫，但没有一个佣兵靠近他。 他终于俯下身，把号角放在地上，雪熄灭了它的火焰。 然后他起身继续走，很快就消失在夜色中。\n\n  %randombrother% 捡起号角，把它翻转过来。 一朵玫瑰凋谢了，即使在黑暗中，它的花瓣也是透明的，柔软的，但已经在严寒中卷曲。 你四处寻找那位老人，发现他的足迹仍未消失。}",
    "stage": 1,
