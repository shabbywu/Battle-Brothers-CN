[
  {
    "ID": 293414945,
    "key": "]+50[/color] Experience",
    "original": "]+50[/color] Experience",
    "translation": "]+50[/color] 经验值",
    "stage": 1,
    "context": "text = _event.m.Anatomist.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+50[/color] Experience'"
  },
  {
    "ID": 293414946,
    "key": "Damn fool.",
  ...
  },
  {
    ...
    "translation": "停止了。",
    "stage": 1,
    "context": "_event.m.Monk.improveMood(1.0, 'Stopped ' + _event.m.Anatomist.getName() + \" from sullying the company's reputation\")"
  },
  {
    "ID": 293414948,
  ...
  {
    "ID": 293414950,
    "key": "Learned something about dealing with the peasantry",
    "original": "Learned something about dealing with the peasantry",
    "translation": "学会了如何处理农民。",
    "stage": 1,
    "context": "_event.m.Anatomist.improveMood(0.5, 'Learned something about dealing with the peasantry')"
  },
  {
    "ID": 293414951,
    "key": " gains [color=",
  ...
  {
    "ID": 293414952,
    "key": "[img]gfx/ui/events/event_40.png[/img]{As %anatomist% tries to move past you, %monk% the monk intervenes. He stands by the anatomist and calmly explains that just because someone is wrong needn't mean that a foreign party step in and correct them. The loss",
    ...
    "translation": "[img]gfx/ui/events/event_40.png[/img]{当%anatomist%试图移动时，僧侣%monk%介入了。他站在解剖学家身边，平静地解释说，仅仅因为某人错了，并不意味着外国一方必须介入并纠正他们。在公众的眼中，失去面子不会因为被纠正的个人而结束，它只会把批判的光芒再次照回那个批评的人身上。%anatomist%思索了一段时间。%SPEECH_ON%你是在告诉我，这里的错误不在于提供的劣质建议，而在于整个社区被谎言所污染，事实的到来会不会煽动维护错误信仰的热情？%SPEECH_OFF%僧侣皱起嘴唇耸了耸肩。%SPEECH_ON%是的。%SPEECH_OFF%解剖学家没有进一步反驳，走开了，也许还在考虑某些科学要素。他走后，僧侣摇了摇头。%SPEECH_ON%我只是不希望他变成一个混蛋，让%companyname%陷入比必要更多的麻烦中。%SPEECH_OFF%你同意，感谢僧侣用更好的话来表达这个观点，而这比你说的话更恰当。}",
    "stage": 1,
    "context": "Text = \"[img]gfx/ui/events/event_40.png[/img]{As %anatomist% tries to move past you, %monk% the monk intervenes. He stands by the anatomist and calmly explains that just because someone is wrong needn't mean that a foreign party step in and correct them. The loss of face in the public's eye is not going to end with the individual being corrected, it will merely bring the light of scrutiny back upon the one doing the criticizing. %anatomist% thinks this over for a time.%SPEECH_ON%Are you telling me that the error here is not in the poor advice being given out, but in the community as a whole being so maligned with falsehoods that an entrance of truth would do not all but stoke a fire to protect what they wrongfully believe?%SPEECH_OFF%The monk purses his lips and shrugs.%SPEECH_ON%Sure.%SPEECH_OFF%The anatomist does not combat it any further and walks off, perhaps mulling over some scientific element to the affair. After he is gone, the monk shakes his head.%SPEECH_ON%I just don't want him being an arse and getting the %companyname% in more trouble than it needs to be.%SPEECH_OFF%You agree, and thank the monk for putting it in better words than you ever could.}\""
  },
  {
    "ID": 293414953,
    "key": "[img]gfx/ui/events/event_20.png[/img]{You come into %townname% to find a white bearded and eloquent elder helping a family with their ill child. To you, this sight isn't anything unusual. To %anatomist% the anatomist, however, some great offense is at han",
    ...
    "translation": "[img]gfx/ui/events/event_20.png[/img]{你进入%townname%，看到一个白胡子慷慨激昂地帮助一家人治疗他们的生病孩子。对你而言，这情景并不稀奇。但对解剖师%anatomist%而言，这里出现了一些极大的冒犯。他迅速走到路对面的老人身边，你跳到他面前拦住他，感觉他的行为可能会给整个%companyname%带来负面影响。%anatomist%站直了身子。%SPEECH_ON%打扰一下，这个人正在提供错误的医疗建议，我需要纠正他。%SPEECH_OFF%你提醒他要注意本地的风俗习惯，插手这些事情可能会有不智之处，而老人几乎肯定是乡里人的代表。他可能也非常重要，比如监督当地的民兵组织。但解剖师对这个任务非常努力，他想要武装自己的知识并使用它，即使这会撕裂当地的政治局势。}",
    "stage": 1,
  ...
  {
    "ID": 293414954,
    "key": "Go on and correct him then.",
  ...
  {
    "ID": 293414956,
    "key": "Had his medical advice rejected",
    "original": "Had his medical advice rejected",
    "translation": "医疗建议被拒绝了。",
    "stage": 1,
    "context": "_event.m.Anatomist.worsenMood(1.0, 'Had his medical advice rejected')"
  },
  {
    "ID": 293414957,
    "key": "[img]gfx/ui/events/event_141.png[/img]{You think it over for a time, and decide to let the anatomist do as he pleases. Stepping aside, you turn to watch the goings on, hoping that this won't be an event to tarnish the %companyname%'s name any more than th",
    ...
    "translation": "[img]gfx/ui/events/event_141.png[/img]{你思考了一会儿，最终决定让解剖学家随心所欲。你侧步而退，转身观看着这场闹剧，希望这不会让%companyname%的名声变得更糟。%anatomist%走到老人身边，他们对视了一会儿，一些农民也盯着他们看。解剖学家蹲下来问老人是否意识到他是个江湖骗子。你捂着头。老人站起来，把解剖学家向后推了一下。%SPEECH_ON%你到底是哪里来的，又带着一箱子花言巧语，是吧？%SPEECH_OFF% 解剖学家举起手来，试图解释他来自一所受过良好教育的学校，突然之间一个农民走到他身旁，打了他一巴掌，把他打倒在泥里。%companyname%的成员冲上去保护解剖学家，在混战中又交换了几拳，但好在最终没有太大的事端。你让%anatomist%重新加入队伍，并下令大家平静下来，以免把%companyname%卖剑手的一面暴露在观众面前。老人点头表示他不希望把这些事情拿给警卫队看。看来大家勉强避过了更加惨烈的斗争。%anatomist%只是看着鼻子里的血，思考是否有人在计算凝固所需的时间。}",
    "stage": 1,
  ...
  },
  {
    ...
    "stage": 1,
    "context": "text = _event.m.Monk.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + resolveBoost + '[/color] Resolve'"
  },
  {
    "ID": 293414959,
    "key": "Thanks, %monk%.",
  ...
  {
    "ID": 293414960,
    "key": "%monk%, can you talk some sense into him?",
    "original": "%monk%, can you talk some sense into him?",
    "translation": "（队长）%monk%，你能劝劝他吗？",
    "stage": 1,
  ...
  {
    "ID": 293414963,
    "key": "Gave medical advice to a receptive audience",
    "original": "Gave medical advice to a receptive audience",
    "translation": "向一个愿意接受的听众提供医疗建议。",
    "stage": 1,
    "context": "_event.m.Anatomist.improveMood(1.0, 'Gave medical advice to a receptive audience')"
  },
  {
    "ID": 293414964,
    "key": "Let's get on on the road.",
  ...
  {
    "ID": 293414965,
    "key": "[img]gfx/ui/events/event_17.png[/img]{You think it over for a time, and decide to let the anatomist do as he pleases. Stepping aside, you turn to watch the goings on, hoping that this won't be an event to tarnish the %companyname%'s name any more than thi",
    ...
    "translation": "[img]gfx/ui/events/event_17.png[/img]{你沉思了一会儿，决定任由解剖学家为所欲为。离开一旁，你转身观察着周围的情况，希望这次事件不会比这个自以为是的杂碎已经做过的更丢%companyname%的脸。%anatomist%走到老人身边，他们对视了一会儿，这时几个农民也看了过来。解剖学家蹲了下来，问老人他的观点是否正确。\n\n出人意料的是，老人愿意接受他的建议，两人一起坐下聊了很长时间。镇民们并没有被外来者的意见所冒犯，相反，他们对这些知识充满了好奇。虽然有些琐碎的细节存在争议，但%anatomist%自己被这种接待所感动，他随手挥了挥手，甚至撒谎说这些问题仍然有待医学界的研究，来化解这些分歧。等当一切结束时，解剖学家将一些笔记交给老人，村民们也用食品和物品表示感谢。}",
    "stage": 1,
  ...
  {
    "ID": 293414966,
    "key": "Was denied the chance to correct improper medical practice",
    "original": "Was denied the chance to correct improper medical practice",
    "translation": "被拒绝纠正不当的医疗行为的机会。",
    "stage": 1,
    "context": "_event.m.Anatomist.worsenMood(1.0, 'Was denied the chance to correct improper medical practice')"
  },
  {
    "ID": 293414967,
    "key": "It's not worth upsetting the locals.",
    "original": "It's not worth upsetting the locals.",
    "translation": "不值得惹恼当地人。",
    "stage": 1,
    "context": "Text = \"It's not worth upsetting the locals.\""
  },
  {
    "ID": 293414968,
    "key": "[img]gfx/ui/events/event_64.png[/img]{%anatomist% moves to get past you, but you put your hand to him and hold him where he is. You explain that correcting locals on their own customs and beliefs is dangerous ground to trod on, and as a sellsword you're a",
    ...
    "translation": "[img]gfx/ui/events/event_64.png[/img]{%anatomist%向你走来，想从你身边穿过去，但你伸手挡住了他。你解释说，纠正当地人的习俗和信仰是危险的，而你作为一个佣兵已经不受信任，被看成是不良分子。你最不需要的就是让村民的传统受到更多的冒犯。解剖学家抗议，但你并不动摇。如果他想要一直去纠正每一个人的一切，他可以回到他来的学校或大学。最终，%anatomist%默默离开。你回头看镇长时，恰好看到他咬下一只青蛙的头并把它的血倒入一个碗中进行未来的占卜。}",
    "stage": 1,
  ...
  {
    "ID": 293414969,
    "key": " from sullying the company's reputation",
