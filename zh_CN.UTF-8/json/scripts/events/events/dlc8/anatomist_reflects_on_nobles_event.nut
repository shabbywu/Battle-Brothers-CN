[
  {
    "ID": 293415086,
    "key": "Better understands the limits of his volition",
    "original": "Better understands the limits of his volition",
    "translation": "更好地理解他的意志限制。",
    "stage": 1,
    "context": "_event.m.Anatomist.improveMood(1.0, 'Better understands the limits of his volition')"
  },
  {
    "ID": 293415087,
    "key": "[/color] Resolve",
    ...
    "stage": 1,
    "context": "text = _event.m.Anatomist.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + resolve_boost + '[/color] Resolve'"
  },
  {
    "ID": 293415088,
    "key": "During camp...",
