[
  {
    ...
    "translation": "教授了",
    "stage": 1,
    "context": "_event.m.Oathtaker.improveMood(0.5, 'Has taught ' + _event.m.Apprentice.getName() + ' something')"
  },
  {
    "ID": 293415239,
    "key": " something",
  ...
  },
  {
    ...
    "stage": 1,
    "context": "text = _event.m.Apprentice.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + resolveBoost + '[/color] Resolve'"
  },
  {
    "ID": 293415241,
    "key": " gains [color=",
  ...
  },
  {
    ...
    "translation": "学习 ",
    "stage": 1,
    "context": "_event.m.Apprentice.improveMood(1.0, 'Learned from ' + _event.m.Oathtaker.getName())"
  },
  {
    "ID": 293415244,
    "key": "Not that I want that to happen.",
    "original": "Not that I want that to happen.",
    "translation": "我不希望那种情况发生。",
    "stage": 1,
    "context": "Text = 'Not that I want that to happen.'"
  },
  {
    "ID": 293415245,
    "key": "[img]gfx/ui/events/event_05.png[/img]{%apprentice% the apprentice is sitting beside the campfire when %oathtaker% the Oathtaker starts sizing him up. The apprentice returns a confused look.%SPEECH_ON%What is it?%SPEECH_OFF%The Oathtaker grins.%SPEECH_ON%Y",
