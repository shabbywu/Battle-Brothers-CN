[
    ...
    {
        "key": "[img]gfx/ui/events/event_31.png[/img]{You pay them the gold. They take it and walk off laughing. %anatomist% explains that he never killed any kid, nor would he ever if there wasn't scientific value to be had in it. You close your eyes and ask him if he would kill a kid if there was scientific value in it. The anatomist scoffs.%SPEECH_ON%I'd lay waste to them, sir.%SPEECH_OFF%}",
    ...
    },
    {
        ...
        "context": "'You lose [color=' + this.Const.UI.Color.NegativeEventValue + ']750[/color] Crowns'"
    },
    {
    ...
    },
    {
        ...
        "context": "_event.m.Cultist.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+' + initiativeBoost + '[/color] Initiative'"
    },
    {
        "key": "At %townname%",
