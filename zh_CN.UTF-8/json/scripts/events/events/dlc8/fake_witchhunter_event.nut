[
    ...
    {
        "key": "[img]gfx/ui/events/event_43.png[/img]{While the goings on of a drunken lynch mob is the preferred form of peasant entertainment, you smell a bit of danger in the air and move the %companyname% to the edge of town. You just never know when these things get out of hand and the laymen start laying hands on everyone in sight.}",
