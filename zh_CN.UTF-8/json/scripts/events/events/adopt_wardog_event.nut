[
    ...
    {
        "key": "[img]gfx/ui/events/event_27.png[/img]You take a bow and nock an arrow. A few of the brothers watch as you take aim. The wind comes, goes, and comes again. You wait patiently before drawing the string and closing one eye to put the dog into focus. It sits down and stares at you between long-tongued pants.\n\nYou release the shot. The arrow zips through the air and the dog yelps. It keels back on its hind legs and falls over, its feet kicking and scraping on the ground until it stops. You put the bow back into its holding and get the company back on the road.",
    ...
    },
    {
        ...
        "translation": "%houndmaster%，你受过驯养狗的训练，对吗？",
        "context": ""
    },
    {
    ...
    {
        "key": "[img]gfx/ui/events/event_27.png[/img]You ask %houndmaster% the houndmaster if he can try and 'woo' this dog. He nods and steps toward it. The wild mongrel's ears go from pinned to pointed. Crouched, the houndmaster slowly edges his way toward the beast. He keeps his hand out with a piece of meat in the palm. Hunger overcomes heedfulness and the dog sniffs its way ever closer to the houndmaster's hand. The dog tongues it out of his palm and chows down. The dog trainer feeds him another bite. He scruffs him up and finds the sweet spot behind his ears. Looking back, %houndmaster% nods.%SPEECH_ON%Aye, it's an agreeable beast and will be easily trained.%SPEECH_OFF%That's great. You ask if it can fight. The houndmaster purses his lips.%SPEECH_ON%A dog is akin to a man. If it can breathe, it can fight.%SPEECH_OFF%",
