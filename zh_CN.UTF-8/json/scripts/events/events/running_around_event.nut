[
  ...
  },
  {
    ...
    "translation": "%terrainImage%{走走路，跑跑步，打打仗，操操逼，都是些有益身心健康的事情。 在大陆上四处旅行的时间锻炼了你战团成员的精气与活力。 你甚至看见过一个脸皮厚的雇佣兵弯腰走进池塘里，像个傻缺一样欣赏自己的倒影。 | 在大陆上来回奔走锻炼了战团成员的体力。 一个在原地跑步，把一根手指抵在脖子上。 他声称他的心率根本没有升高。 另一个兄弟说那家伙连数数都不知道。 跑步的那个佣兵停了下来。%SPEECH_ON%Oh. 你说得对。%SPEECH_OFF%}",
    "stage": 1,
    "context": "Text = \"%terrainImage%{Walking, running, fighting, fucking, all good for a man's heart. The time spent traveling the land has improved the vitality and vigor of the men. You even caught one of the cheekier mercenaries flexing into pondwater, admiring his own reflection like some smirkin' wench. | All this running about the land has increased the stamina of the men. One runs in place, holding a finger to his neck. He remarks that his heart rate isn't going up at all. Another brother remarks that the guy doesn't even know how to count. The running man pauses.%SPEECH_ON%Oh. That's right.%SPEECH_OFF%}\""
  },
  {
    "ID": 293416704,
