[
  {
    "ID": 293412606,
    "key": "Was cured of a curse",
    "original": "Was cured of a curse",
    "translation": "被诅咒治愈",
    "stage": 1,
    "context": "_event.m.Cursed.improveMood(3.0, 'Was cured of a curse')"
  },
  {
    "ID": 293412607,
    "key": "You spend [color=",
    ...
    "stage": 5,
    "context": "'text' = 'You spend [color=' + this.Const.UI.Color.NegativeEventValue + ']' + 400 + '[/color] Crowns'"
  },
  {
    "ID": 293412608,
    "key": "[/color] Crowns",
  ...
  {
    "ID": 293412610,
    "key": "If it must be... go take care of it. Here are the crowns.",
    "original": "If it must be... go take care of it. Here are the crowns.",
    "translation": "如果必须要如此…那就去做吧。 这是那些数目的克朗。",
    "stage": 1,
    "context": "'Text' = 'If it must be... go take care of it. Here are the crowns.'"
  },
  {
    "ID": 293412611,
    "key": "The things I put up with...",
    "original": "The things I put up with...",
    "translation": "这事我忍了…",
    "stage": 1,
    "context": "'Text' = 'The things I put up with...'"
  },
  {
    "ID": 293412612,
    "key": "[img]gfx/ui/events/event_05.png[/img]You snap your fingers, suddenly remembering %sorcerer%, the so-called sorcerer. Wanting to not spend another minute being a part of this bizarre affair, you refer %superstitious% to the sorcerer. He is quick to leave, ",
    ...
    "translation": "[img]gfx/ui/events/event_05.png[/img]你打着响指，突然想起 %sorcerer%，这个所谓的巫师。 你不想再多花一分钟来参与这件荒谬的事情，就向巫师提及 %superstitious%。 他很快就离开了，但不幸的是几分钟后他又回来了，解释说 %sorcerer% 已经帮他解除了诅咒。%SPEECH_ON%我力所能及的做了…%SPEECH_OFF%你举起手，让他的故事就此打住。 他问你想不想听剩下的部分，你坚决地拒绝了。",
    "stage": 1,
    "context": "'Text' = \"[img]gfx/ui/events/event_05.png[/img]You snap your fingers, suddenly remembering %sorcerer%, the so-called sorcerer. Wanting to not spend another minute being a part of this bizarre affair, you refer %superstitious% to the sorcerer. He is quick to leave, but unfortunately returns a few minutes later, explaining that %sorcerer% has set him free from his curse.%SPEECH_ON%All I had to do was...%SPEECH_OFF%You hold your hand up, stopping the man's story right where it be. He asks if you want to hear the rest of it and you give a firm no.\""
  },
  {
    "ID": 293412613,
    "key": "This isn't going to happen.",
    "original": "This isn't going to happen.",
    "translation": "这不会发生的。",
    "stage": 1,
    "context": "'Text' = \"This isn't going to happen.\""
  },
  {
    "ID": 293412614,
    "key": " gains [color=",
    ...
    "stage": 1,
    "context": "'text' = _event.m.Cursed.getName() + ' gains [color=' + this.Const.UI.Color.PositiveEventValue + ']+1[/color] Resolve'"
  },
  {
    "ID": 293412615,
  ...
  {
    "ID": 293412616,
    "key": "Have %sorcerer% the sorcerer take a look instead.",
    "original": "Have %sorcerer% the sorcerer take a look instead.",
    "translation": "让 %sorcerer% 这个巫师替你看一眼。",
    "stage": 1,
    "context": "'Text' = 'Have %sorcerer% the sorcerer take a look instead.'"
  },
  {
    "ID": 293412617,
    "key": "That should put an end to this.",
    "original": "That should put an end to this.",
    "translation": "那个事就应该这样收场。",
    "stage": 1,
    "context": "'Text' = 'That should put an end to this.'"
  },
  {
    "ID": 293412618,
    "key": "Have %monk% the monk take a look instead.",
    "original": "Have %monk% the monk take a look instead.",
    "translation": "让 %monk% 这个僧侣替你看一下。",
    "stage": 1,
    "context": "'Text' = 'Have %monk% the monk take a look instead.'"
  },
  {
    "ID": 293412619,
    "key": "]+1[/color] Resolve",
  ...
  {
    "ID": 293412624,
    "key": "[img]gfx/ui/events/event_05.png[/img]You further muddy %superstitious%'s poor countenance with some bad news: you're not paying any witch anything.%SPEECH_ON%A few farcical words from some strange woman in the woods is no basis for an exchange of business",
    ...
    "translation": "[img]gfx/ui/events/event_05.png[/img]你很快用一些坏消息把一脸可怜相的 %superstitious% 弄糊涂了：你没有给任何一个女巫任何东西。%SPEECH_ON%这是一些奇怪女人在森林里的玩笑，不能作为一场生意的依据。 你所听到的是一个婊子企图骗你呢，雇佣兵。 你不能听这种废话，尤其是一个婊子的废话，因为婊子的废话就是为了某个人的硬币。%SPEECH_OFF%这些话对 %superstitious% 毫无用处，因为他很快就逃出了帐篷，也许是去找另一个可以借给他钱的雇佣兵。",
    "stage": 1,
    "context": "'Text' = \"[img]gfx/ui/events/event_05.png[/img]You further muddy %superstitious%'s poor countenance with some bad news: you're not paying any witch anything.%SPEECH_ON%A few farcical words from some strange woman in the woods is no basis for an exchange of business. What you've heard is a tramp's attempt to get at you, mercenary. You cannot listen to such tripe, especially a tramp's tripe for a tramp's tripe is always in pursuit of one's coin.%SPEECH_OFF%None of these words help %superstitious% for he quickly runs out of the tent, perhaps in pursuit of another mercenary who will give him a loan.\""
  },
  {
    "ID": 293412625,
    "key": "[img]gfx/ui/events/event_05.png[/img]%superstitious% enters your tent with hat in hand. The rim of it turns round and round in his fingers as though he were plucking feathers from it. Even though you haven't said a word the man's head nods furiously and h",
    ...
    "translation": "[img]gfx/ui/events/event_05.png[/img]%superstitious% 走进你的帐篷手里拿着帽子。 帽子的边缘在他的手指间一圈又一圈地转着，好像他在拔帽子的羽毛。 即使你一个字也没说，那个男人还是狂怒地点头，他的眼睛扫视四周，好像在寻找要说的话。\n\n你放下羽毛笔，问是什么问题。 他舔了舔嘴唇，又点头，开始解释他的困境。 他说得很快，是当地的一个女巫诅咒他，说他是性无能，大概意思就是这样。\n\n你摇着头，问那女巫想要什么，%superstitious% 说 %payment% 克朗，以免自己一辈子都受到诅咒。",
    "stage": 1,
    "context": "'Text' = \"[img]gfx/ui/events/event_05.png[/img]%superstitious% enters your tent with hat in hand. The rim of it turns round and round in his fingers as though he were plucking feathers from it. Even though you haven't said a word the man's head nods furiously and his eyes jet around as if looking for the words to say.\n\nYou put your quill pen down and ask what the issue is. Licking his lips, he nods again and begins to explain his predicament. The words come fast, but the general gist of it seems to be that a local witch has cursed the man to be incapable of some sexual export, as it were.\n\nYou shake your head and ask what it is the witch wants and %superstitious% says %payment% crowns, lest the curse be on him for life.\""
  }
]
