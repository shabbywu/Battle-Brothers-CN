[
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_79.png[/img]%cultist% 走上前去，上下打量着村民。他摇了摇头。%SPEECH_ON%你们都该自杀。%SPEECH_OFF%村里的僧侣把斗篷晃的沙沙作响。%SPEECH_ON%你说啥？%SPEECH_OFF%异教徒开始释放女人。 你的一些雇佣兵站出来阻止任何人的抗议。 当她自由后，被允许逃往安全的地方，%cultist% 又说了一遍。%SPEECH_ON%自尽吧。你们每个人。今晚。 你们激怒了达库尔，他的愤怒是你们最好的债务。%SPEECH_OFF%僧侣张开嘴想说点什么，但他的鼻子裂开了，就像被一块看不见的石头压出的凹痕。 他踉踉跄跄，鼻孔里血流不止。%cultist% 点头。%SPEECH_ON%哼，他比我想象的更生气。 达库尔即将降临到我们，但他现在就在你们的门前。%SPEECH_OFF%僧侣尖叫着倒在了地上，下巴裂成两半，嘴巴永远半掩着。 村民们尖叫着四散而逃就像兔子看到了鹰的影子。",
    "stage": 1
  },
  {
    "key": "Let's free her.",
