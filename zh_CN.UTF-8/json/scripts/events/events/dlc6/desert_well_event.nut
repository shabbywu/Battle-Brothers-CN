[
    ...
    {
        "key": "%terrainImage%{The man nods.%SPEECH_ON%That ain't no watering hole, that's a cannon. I got a pile of fire powder in the bottom. The chute is armed with buckets, and fishing rods, all manner of cutlery, some soldier's metal boots, a broken sword, couple of scabbards, I think a few animals fell in but they no doubt dead now, if not they're going for a ride.%SPEECH_OFF%}",
