[
  {
    "ID": 293414490,
    "key": "I'll pay you 500 crowns right now if you join us.",
    "original": "I'll pay you 500 crowns right now if you join us.",
    "translation": "我现在就付500克朗，只要你愿意加入我们。",
    "stage": 1,
  ...
  },
  {
    ...
    "stage": 1,
    "context": "text = 'You spend [color=' + this.Const.UI.Color.PositiveEventValue + ']500[/color] Crowns'"
  },
  {
    "ID": 293414492,
    "key": "[img]gfx/ui/events/event_163.png[/img]{You offer five hundred crowns to the dancer. He keeps picking up coins - one at a time - and putting them in his clay pot. It is almost a silent affair, coins clapping loudly as they fall into a nearly empty barrel o",
    ...
    "translation": "[img]gfx/ui/events/event_163.png[/img]{你向舞者提出了这五百克朗。 他继续捡着硬币－一次一个－并将它们放到他的陶罐子里。 静悄悄的，只有硬币碰撞和掉入一个近乎空的陶罐中的声音。 他上下观望。 他将又一个克朗放入并站了起来。 他脱下他的衣服并伸出手。%SPEECH_ON%镀金者一定照耀这我们两人，看你能赚取这么一笔财富，无疑他把你的钱袋领向这里是为了交给我。%SPEECH_OFF%你点头并和他握手。 一个路过的人瞥过来挠着他的头说。%SPEECH_ON%等一下，你下面有条蛇！ 我以为你是个舞女，啊这…%SPEECH_OFF%他擦了擦额头并压低了声音。%SPEECH_ON%这不是更好了吗。%SPEECH_OFF%叹着气，舞者想看看你的库存。%SPEECH_ON%我这样的身体，什么装备都能穿上的，不论内层外层，都可以。%SPEECH_OFF%}",
    "stage": 1,
    "context": "Text = \"[img]gfx/ui/events/event_163.png[/img]{You offer five hundred crowns to the dancer. He keeps picking up coins - one at a time - and putting them in his clay pot. It is almost a silent affair, coins clapping loudly as they fall into a nearly empty barrel of clay. He looks up, looks down. He puts in one more crown then gets to his feet. He strips off his clothes and holds out his hand.%SPEECH_ON%The Gilded One must be gleaming upon us both, for you to have earned such keep, and no doubt He has guided your purse here to bring it to me.%SPEECH_OFF%You nod and shake his hand. A passerby glances over and scratches his head.%SPEECH_ON%Wait a minute, you've a snake down there! I thought you were a lady of the dance, but this...%SPEECH_OFF%He dabs his forehead and lowers his voice.%SPEECH_ON%This makes it even better.%SPEECH_OFF%Sighing, the dancer asks that he take a look at your inventory.%SPEECH_ON%A body like mine, anything will fit, inside or out, I'll make it work.%SPEECH_OFF%}\""
  },
  {
    "ID": 293414493,
    "key": "[img]gfx/ui/events/event_163.png[/img]{You tell the dancer that he is one of the best you've seen with a blade. He laughs.%SPEECH_ON%A truly well intentioned attempt on your part, Crownling, to drag me to your ways of life. But you know well that there is",
    ...
    "translation": "[img]gfx/ui/events/event_163.png[/img]{你告诉舞者他是你见过的最好的刀锋之一。他笑了。%SPEECH_ON%你努力的很好，逐币者，试图把我拖到你的生活方式上。 但是你知道的，说或做，你无法将我从这种生活中剥离。 是的，刀很适合我，但为了群众起舞，不溅血的获得赞美。 你就在沙地上扮演角斗士挣你的硬币吧，逐币者，而我会在这里赚我的。%SPEECH_OFF%}",
    "stage": 1,
  ...
  {
    "ID": 293414495,
    "key": "[img]gfx/ui/events/event_163.png[/img]{You take out a crown and flip it to the dancer. Her eyes catch its glint, but she doesn't break the dance. She drops her weapons and sashays over, cymbals clattering, hips gyrating, her knees hardly bending, her feet",
    ...
    "translation": "[img]gfx/ui/events/event_163.png[/img]{你取出一克朗并掷向舞者。 她的眼睛捕捉到了它的微光，但这没有影响到她的舞蹈。 她放下她的武器神气的靠过来，钹碰撞着，她的膝盖微微弯曲，她的脚以一种神秘的方式让她掠过地面。 她近了。脸窄而小，下颌宽。 她的额角深邃。她笑了。 这是个男人。她是一个男人。 他在你面前拍响钹，然后摆过身去，他的屁股轻微的抚摸过你的腹股，并舞动着返回中央。 他用脚尖踮起了你的硬币，旋转着，硬币落入了一个陶罐。群众欢呼了起来。}",
    "stage": 1,
  ...
  {
    "ID": 293414498,
    "key": "[img]gfx/ui/events/event_163.png[/img]{You assuage his ego by saying he's one of the best with the blade you've seen. The dancer turns his hands to the dust, his fingers sliding beneath each coin and flipping it into his clay pot. His left hand reaches ac",
  ...
  {
    "ID": 293414502,
    "key": "Well done, have a crown.",
    "original": "Well done, have a crown.",
    "translation": "很出色，这是一克朗。",
    "stage": 1,
    "context": "Text = 'Well done, have a crown.'"
  },
  {
    "ID": 293414503,
    "key": "[img]gfx/ui/events/event_163.png[/img]{A belly dancer magnetizes %townname%'s center plaza. Rhythmic movements on their own can coerce a beggar to donating a crown, but with the stage of the whole plaza it is enough to draw crowds and with it heaps of gol",
    ...
    "translation": "[img]gfx/ui/events/event_163.png[/img]{一个肚皮舞者在 %townname%的中心广场吸引着人群。有节奏的运动本身能让一个乞丐献出一克朗，但是以一整个广场为舞台，这足够引来人群和成堆的金子。舞者身穿薄丝绸，遮盖了半身，饰有透明的深绿色面纱。她无疑是自己领域的专家。她转动着，臀部充满魅惑，手肘弯曲，手抓着小铜钹鼓。她的脚尖踮起着在一个点上旋转，如此稳定好似有一个隐形的神使她在眼花缭乱的运动中保持原地。\n\n突然有人向空中扔了一个苹果，舞者立刻转身，用一把小匕首刺了进去，并且打在了目标中心，果实掉落在地上。然后又有一个苹果被扔了进来，这次舞者拿出了一把大刀，砍断了茎，并抓住剩下的部分咬了一口。人群轻轻拍掌为她喝彩。}",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "]1[/color] 克朗",
    "stage": 1,
    "context": "text = 'You spend [color=' + this.Const.UI.Color.NegativeEventValue + ']1[/color] Crown'"
  },
  {
    "ID": 293414506,
  ...
  {
    "ID": 293414508,
    "key": "You've talent with the blade like I've never seen before.",
    "original": "You've talent with the blade like I've never seen before.",
    "translation": "你运用刀刃的天赋是我前所未见的。",
    "stage": 1,
