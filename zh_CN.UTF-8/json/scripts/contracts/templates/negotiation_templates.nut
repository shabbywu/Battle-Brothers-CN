[
  ...
  },
  {
    ...
    "translation": "我们需要你为每个人头付更多的钱。",
    "stage": 1,
    "context": "this.Contract.m.Payment.Count == 0 ? 'We need to be paid per head we return with.' : 'We need to be paid more per head we return with.'"
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_04.png[/img]{他点了点头。%SPEECH_ON%好的。很好。我想的就是提前给你们报酬。 | 他笑了笑。%SPEECH_ON%朋友，你们很快就能发大财了。 | 他深呼吸了一口气。%SPEECH_ON%非常好，这是我准备给你的报价。 | 他手放在你肩头，微笑中透着肯定。%SPEECH_ON%我想我知道一个适当的报酬来支付你的服务。 | 他用手做出手势，指着手指好像在数些什么，但对你来说没有任何意义。%SPEECH_ON%根据经验来看，这对这项任务来说是很好的报酬。 | 他点了点头。%SPEECH_ON%你看起来挺有能力的，我愿意慷慨解囊。 | 他晃动着一袋硬币。%SPEECH_ON%如果你能帮我处理这件事，这些硬币就是你的了。 | 他摊开了双手。%SPEECH_ON%我现在手头比较紧，所以在你问之前，这就是我现在所有的钱了。 | %SPEECH_ON%请放心，我现在所提供的报酬对于你的工作来说是非常不错的。} ",
    "stage": 1,
    "context": "this.Text = \"[img]gfx/ui/events/event_04.png[/img]{He nods.%SPEECH_ON%Yes. Good. I was thinking about payment for your task earlier. | He smiles.%SPEECH_ON%This will make you a rich man, my friend. | He takes a deep breath.%SPEECH_ON%Very well, this is what I'm prepared to offer you. | He puts his hand on your shoulder, smiling reaffirmingly.%SPEECH_ON%I think I know an adequate compensation for your services. | He gesticulates with his hands, pointing at his fingers as if counting something, but it means nothing to you.%SPEECH_ON%Judging from experience, this is good payment for the task. | He nods. %SPEECH_ON%You look able, so I am willing to pay quite a bit. | He jingles with a bag of coins.%SPEECH_ON%This will be yours if you help me out on this. | He opens the palm of his hands.%SPEECH_ON%I'm tight on crowns, so before you ask, this is all I have right now. | %SPEECH_ON%Rest assured that what I'm offering you now is a fine prize for your work.} \""
  },
  {
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_04.png[/img]{%SPEECH_START%我拒绝再为此付出更多的报酬。 | %SPEECH_START%要理性一些。  | %SPEECH_START%不，不，不。 | %SPEECH_START%你觉得你是谁？我告诉你，如何支付报酬是我决定的。  | 他只是严肃地看着你，摇了摇头。%SPEECH_ON% | %SPEECH_START%不可能！%SPEECH_OFF%他愤怒地大吼。%SPEECH_ON% | %SPEECH_START%不，你已经得到的比你应得的更多了。 | %SPEECH_START%不。不要把我逼急了！ | %SPEECH_START%我认为你还没有完全理解这个问题的运作方式。如果你想要钱，我们需得达成协议。我的报价仍然有效。}",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "我们需要按照我们带来的人头数付款。",
    "stage": 1,
    "context": "this.Contract.m.Payment.Count == 0 ? 'We need to be paid per head we arrive with.' : 'We need to be paid more per head we arrive with.'"
  },
  {
  ...
  },
  {
    ...
    "stage": 1,
    "context": "this.Contract.m.Payment.Advance == 0 ? 'We need payment in advance.' : 'We need more payment in advance.'"
  },
  {
  ...
  },
  {
    ...
    "translation": "我们不会为了微薄的报酬而冒生命危险…",
    "stage": 1
  },
  {
    "key": "We need payment once the work is done.",
    "original": "We need payment once the work is done.",
    "translation": "工作完成后我们需要报酬。",
    "stage": 1,
    "context": "this.Contract.m.Payment.Completion == 0 ? 'We need payment once the work is done.' : 'We need more payment once the work is done.'"
  },
  {
  ...
  },
  {
    ...
    "translation": "我们需要为我们带来的每个人头数付更多的款。",
    "stage": 1,
    "context": "this.Contract.m.Payment.Count == 0 ? 'We need to be paid per head we arrive with.' : 'We need to be paid more per head we arrive with.'"
  },
  {
  ...
  },
  {
    ...
    "translation": "你方谈判的合同如下。你同意这些条款吗？",
    "stage": 1
  }
]