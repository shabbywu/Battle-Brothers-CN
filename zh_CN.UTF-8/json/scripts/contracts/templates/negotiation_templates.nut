[
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_04.png[/img]{%SPEECH_START%我拒绝再为此付出更多的报酬。 | %SPEECH_START%给我理性点。 | %SPEECH_START%不，不，不。 | %SPEECH_START%你以为你是谁？给多少报酬是我决定的。 | 他只是严肃地看着你，摇了摇头。%SPEECH_ON% | %SPEECH_START%没门！%SPEECH_OFF%他愤怒地大吼。%SPEECH_ON% | %SPEECH_START%不，你已经得到的比你应得的更多了。 | %SPEECH_START%不。不要把我逼急了！ | %SPEECH_START%我觉得你还不太明白怎么回事。如果你想为这个任务得到报酬，我们需要达成一致。我的报价还是那样。}",
    "stage": 5,
