[
  ...
  },
  {
    ...
    "translation": "{不感兴趣。 | 短时间内我们不会去那里。 | 我们不想接这类差事。}",
    "stage": 5,
  ...
  },
  {
    ...
    "stage": 5,
    "context": "this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(this.Const.World.Assets.RelationCivilianContractFail, 'Sold the location of ' + this.Flags.get('Location') + ' to another party')"
  },
  {
    "ID": 293408585,
  ...
  },
  {
    ...
    "translation": "受雇找到了",
    "stage": 5,
    "context": "this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(this.Const.World.Assets.RelationCivilianContractSuccess, 'Hired to find the ' + this.Flags.get('Location'))"
  },
  {
    "ID": 293408589,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_04.png[/img]你向那人保证会对他家族据点的位置守口如瓶。趁他欢庆之际，你转头就把%location%的方位告诉了%employer%。两头收钱真是桩美差——虽然同时遭两边记恨不太妙，但跟佣兵打交道还能指望什么呢？",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "好吧，%employer%本该多付我们一些钱。",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_07.png[/img]%location%已映入眼帘——%companyname%也暴露在对方视野中。那个曾为你们指路的“好心人”就站在那儿，只不过此刻他身边多了一群彪悍而不友善的壮汉。%SPEECH_ON%%SPEECH_ON%{看来你们还是会听从指示的嘛。告诉蠢货在哪儿碰面，设埋伏就容易多了。行了，杀光他们！ | 哟，佣兵。在这儿见到你真意外。等等，才不意外呢。杀光他们！ | 该死，你们来得可真够慢的！怎么，连自投罗网的简单指示都搞不明白？愚蠢的佣兵，简直蠢得令人发指。赶紧了结这事吧。杀光他们。}%SPEECH_OFF%",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_51.png[/img]{你同意向那人出售探险行动的详细信息。他对整件事喜出望外，但%employer%却不然。显然有个小孩目睹了这场交易，并向%townname%的掌权者告发了你的背叛行径。毫无疑问，你在此地的声誉已受到损害。 | 一方面，你使这个人口中的家族宅邸免遭%townname%统治者的摧毁。另一方面，%townname%的掌权者迅速得知了你的所作所为。你早该想到小镇居民本身就是高效的流言传播中介。}",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_57.png[/img]{你用望远镜观察到了%location%，随即将它标注在地图上。没费什么工夫。该回去向%employer%复命了。 | 没想到%location%比预想的更容易找到，现在就该返回%employer%那里了。你将它标在地图上，停顿片刻，摇摇头轻笑出声。运气真不错。 | %location%映入眼帘，你立即用尽毕生绘图功力将它重现于地图上。%randombrother%询问是否只需做这些。你点头确认。无论任务艰难还是轻松，%employer%都会照样付钱。}",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_76.png[/img]你接受了这个人的提议，他如约说出了详细信息。%SPEECH_ON%你看，它就在那儿，从我们现在位置往%direction%方向%distance%处的%terrain%上走。简单得很。%SPEECH_OFF%他吹着口哨走开了，这钱对他来说赚得毫不费力。",
    "stage": 5,
  ...
  },
  {
    ...
    "stage": 5,
    "context": "this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(this.Const.World.Assets.RelationCivilianContractFail * 1.5, 'Gave information to a competitor')"
  },
  {
    "ID": 293408613,
    ...
    "translation": "向%direction%方向搜索，在%region%地区附近寻找%location%。",
    "stage": 5,
    "context": "'Find %location% to the %direction% and around the region of %region%'"
  },
  {
    "ID": 293408614,
  ...
  },
  {
    ...
    "translation": "我觉得不行。只有我们的雇主会知道它在哪里。",
    "stage": 5,
  ...
  {
    "key": "4fc7dd96d2ec9e0db265f59342d9a33b6d456a32758429e5720eb071f46c03f3",
    "original": "Bribe",
    "translation": "",
    "context": ""
  },
  ...
  {
    "key": "d3a008ef1335692d9d045175ba9ea1dcd39ae48da9e2043a9baabad6c3818c28",
    "original": "Region",
    "translation": "",
    "context": ""
  },
  ...
  {
    "key": "e52817818a06d588d6ba37f52bd9309c61d68dcf08d81b9295a0926c8725c392",
    "original": "Trap",
    "translation": "",
    "context": ""
  },
  ...
  {
    "key": "fce07324e0e72e071842374e9997cf65df990cbc6ba4d4723ac28c99e3ad1b36",
    "original": "bribe",
    "translation": "",
    "context": ""
  },
