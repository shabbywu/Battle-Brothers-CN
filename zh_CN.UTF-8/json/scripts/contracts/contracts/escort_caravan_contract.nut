[
  ...
  },
  {
    ...
    "stage": 1,
    "context": "this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(this.Const.World.Assets.RelationBetrayal, 'Slaughtered a caravan tasked to protect')"
  },
  {
    "ID": 293408754,
  ...
  },
  {
    ...
    "stage": 1,
    "context": "this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(this.Const.World.Assets.RelationNobleContractSuccess, 'Protected a caravan as promised')"
  },
  {
    "ID": 293408762,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_50.png[/img]{以为商队护卫走过来。%SPEECH_ON%嗨伙计，让我们回到正路上，好吗？%SPEECH_OFF%你向你的雇佣兵点头。 他点头回应，然后快速的转身一匕首刺穿了护卫的面颊。 战团其余人，意识到在发生什么，很快拔出他们的武器并扑向了卫队。 他们毫无胜算，当血雨腥风告一段落时，你成为了这些优质宝石的新主人。 | 宝石的力量征服了你！ 一串快速的点头及号令，你下令让 %companyname% 杀光了所有的护卫。 事办的很快，看看他们是如何信任你会帮助他们的，几个人直到死仍在问着为什么要如此残忍的背叛他们。 | 这些宝石可比任何合同能给你的有价值多了。 尽可能大声地喊起来，你命令 %companyname% 杀掉所有卫兵。 他们动作很快，毫无质疑，而护卫们还很缓慢并且疑惑。 没过多久你就拥有了宝石。%employer% 不会感到高兴，但让他见鬼去吧，你现在手里有宝石了。}",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "没能保护好商队",
    "stage": 5,
    "context": "this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(this.Const.World.Assets.RelationCivilianContractFail, 'Failed to protect a caravan')"
  },
  {
    "ID": 293408785,
  ...
  },
  {
    ...
    "translation": "贸易商队",
    "stage": 5,
    "context": "faction.spawnEntity(this.m.Home.getTile(), 'Trading Caravan', False, this.Const.World.Spawn.CaravanSouthernEscort, this.m.Home.getResources() * this.Math.rand(10, 25) * 0.009999999776482582)"
  },
  {
    "ID": 293408816,
  ...
  },
  {
    ...
    "stage": 1,
    "context": "this.World.FactionManager.getFaction(this.Contract.getFaction()).addPlayerRelation(this.Const.World.Assets.RelationCivilianContractPoor, 'Protected a caravan, albeit poorly')"
  },
  {
    "ID": 293408826,
    "key": "During camp...",
