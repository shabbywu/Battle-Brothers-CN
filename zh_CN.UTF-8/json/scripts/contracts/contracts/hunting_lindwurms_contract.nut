[
    ...
    },
    {
        ...
        "translation": "{听起来你需要的是英雄和蠢货。 | 它不值得冒险。 | 我不这么认为。}",
        "context": ""
    },
    {
        "key": "Fall back!",
    ...
    },
    {
        ...
        "translation": "[img]gfx/ui/events/event_41.png[/img]{你察觉到一个商人和他的载重货车沿着路靠近。 载重货车的后方被掀起，一同起飞的还有飞得像布娃娃一样的商队成员。 一缕绿色的条纹在商队后面滑动着而另一条抄到了侧面。 商人转身跳进了载重货车里，这时林德沃姆们正展开进攻。 这些无疑正式你在找的生物。 在你的号令下，%companyname% 极速前进，可能还来得及救下这个商队。}",
        "context": ""
    },
    {
        "key": "Return to ",
    ...
    },
    {
        ...
        "translation": "[img]gfx/ui/events/event_60.png[/img]{The battle is over. 你让半队伙计们去剥林德沃姆好回去给 %employer% 看看。 另一半搜寻着商队的残骸。 没有什么值得注意的发现，金子都没有。 一切有价值的东西都在战斗中被敲碎了。 商人自己被分成了两半并且腿落在相当一段距离外，口袋翻出来，空空荡荡的，%randombrother% 蹲在遗体边。他点着头。%SPEECH_ON%好吧，这真是个遗憾的结局。 破碎，而且破产。%SPEECH_OFF%你点头回应然后唤伙计们打好包。 是时候回去找雇主拿报酬了。}",
        "context": ""
    },
    {
        "key": "On your return...",
    ...
    },
    {
        ...
        "translation": "{你要我们完成的可真是份大差事。 | 与这样的敌人作战，我希望有个好价钱。 | 我希望你给我报酬得有点份量。}",
        "context": ""
    }
]