[
    ...
    },
    {
        ...
        "translation": "[img]gfx/ui/events/event_87.png[/img]霍加特死在了他自己的血泊中，僵在一个丑陋且可怕的姿势。 这次他没能逃掉。 你一只脚踩在他的尸体上然后看着你的人。%SPEECH_ON%为了战队。为了所有死去的同伴。%SPEECH_OFF%%bro3% 往死人脸上吐口水。%SPEECH_ON%让我们取下这混蛋的首级然后回到 %townname%%SPEECH_OFF%",
        "context": ""
    },
    {
    ...
    },
    {
        ...
        "translation": "[img]gfx/ui/events/event_79.png[/img]%employer% 叹了口气。%SPEECH_ON%好吧，当然！400克朗，和约定的一样。%SPEECH_OFF%他冲着一个仆人做了个手势，然后仆人手里拿着报酬跑到了你的身边。%SPEECH_ON%我想…我可以再次使用你的服务吗？ 我很想彻底结束霍加特这块心病。 并且我会再付钱给你们。 额外的400克朗，这么说可以吧？%SPEECH_OFF%%bro2% 嗤之以鼻的喝了更多的酒，但是 %bro1% 站起来要说话。%SPEECH_ON%是的，战队被毁了，但我们会重建它！ 没有 %companyname%，%bro2% 会喝酒花光克朗最后流落街头乞讨，还有 %bro3%，诸神在上，我们都知道他会去追女人直到某人把他腐烂的头颅扔进火炉。 我们需要 %companyname%，那是我们拥有的全部！ 你怎么说，队长？%SPEECH_OFF%%bro2% 打了个嗝然后向你举起了他的杯子。%bro3% 调皮地刮了下鼻子然后点了点头。%SPEECH_ON%杀掉那个混蛋霍加特或者不杀，由你来决定，队长。%SPEECH_OFF%",
        "context": ""
    },
    {
        "key": "The %companyname%",
