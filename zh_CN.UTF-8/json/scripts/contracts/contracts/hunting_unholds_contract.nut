[
    ...
    },
    {
        ...
        "original": " suffers ",
        "translation": " 遭受 ",
        "context": "this.Contract.m.Dude.getName() + ' suffers ' + injury.getNameOnly()"
    },
    {
        "key": "You gain [color=",
    ...
    {
        "key": "[img]gfx/ui/events/event_104.png[/img]{As you put the men into formation, %shouter% goes running by you and right toward the unholds. He's hooting and hollering, his arms flailing like a sea cretin drawn up by the hook. The unholds pause and stare amongst one another. You're not sure whether this should be allowed to continue...}",
