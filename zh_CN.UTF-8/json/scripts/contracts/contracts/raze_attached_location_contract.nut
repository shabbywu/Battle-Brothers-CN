[
  ...
  },
  {
    "ID": 293409718,
    "key": "Raze Location",
    "original": "Raze Location",
    "translation": "夷平地点",
    "stage": 1,
    "context": "this.m.Name = 'Raze Location'"
  },
  {
    "ID": 293409719,
    "key": "To arms!",
  ...
  {
    "ID": 293409721,
    "key": "Sweep through from one side!",
    "original": "Sweep through from one side!",
    "translation": "从一侧扫荡！",
    "stage": 1
  },
  {
    "ID": 293409722,
    "key": "{Honest pay for honest work. | Crowns is crowns.}",
    "original": "{Honest pay for honest work. | Crowns is crowns.}",
    "translation": "{诚实的工作得到诚实的报酬。 | 克朗就是克朗。}",
    "stage": 1
  },
  {
    "ID": 293409723,
  ...
  {
    "ID": 293409727,
    "key": "[img]gfx/ui/events/event_141.png[/img]{You reach %location% and immediately tell your men to hold and get down. Peasants are afoot, but so are militia. This was not part of the deal and you must reassess the situation accordingly. | As you near %location%",
    "original": "[img]gfx/ui/events/event_141.png[/img]{You reach %location% and immediately tell your men to hold and get down. Peasants are afoot, but so are militia. This was not part of the deal and you must reassess the situation accordingly. | As you near %location%, %randombrother% returns to you with a scouting report. Apparently, there are not just peasants there. A few militiamen are in the area. If you are to do this, you'll have to fight them, too. What now? | Militia! They were not part of the plan at all! If you are to proceed, you'll have to take care of them along with the peasants. Time to think carefully about this... | What is this? You see militiamen marching around %location%. Now you'll have to do some real fighting if you want to complete your task. | As you ready to attack %location%, %randombrother% points out something in the distance. Slimming your eyes, you bring into focus a handful of what look like militiamen. This was not part of the agreement! You can still go through with the attack, but there will be some resistance...}",
    "translation": "[img]gfx/ui/events/event_141.png[/img]{你到达 %location% 马上告诉你的人趴下。 农民们在，但是还有民兵。 这不是交易的一部分而且你必须重新判断情况。 | 随着你靠近 %location%，%randombrother% 回来报告侦查结果。 很显然，那里不止有农民。 几个民兵在现场。 如果你要上，你就得跟他们也打一场。现在怎么办？ | 民兵！他们完全不是计划中的一部分！ 如果你要继续，你就得像对付农民那样一起对付了。 是时候仔细思考这件事… | 什么？你看到群民兵在 %location% 周围巡逻。现在你得做点实际战斗来完成你的任务了。 | 随着你准备进攻 %location%，%randombrother% 指出远处有什么东西。 眯着眼，你聚焦到一群看起来像是民兵的人。 这不是合同的一部分！ 你依然可以进攻，但是这下会有些抵抗了…}",
    "stage": 1
  },
  {
    "ID": 293409728,
