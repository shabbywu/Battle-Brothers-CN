[
  ...
  },
  {
    ...
    "translation": "团",
    "stage": 5,
    "context": "cityState.spawnEntity(tile, 'Regiment of ' + cityState.getNameOnly(), True, this.Const.World.Spawn.Southern, this.Math.rand(70, 90) * this.Contract.getDifficultyMult() * this.Contract.getScaledDifficultyMult())"
  },
  {
    "ID": 293409309,
