[
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_68.png[/img]{你终于看到了%objective%，并且它处于极度危险之中。城镇正在遭受一连串的绿皮兽攻城战争机器的轰炸。你下令%companyname%准备行动：你将侧翼包抄敌军，并直接攻击这些攻城机械。 | 所有的贵族士兵都已经死亡，你独自到达%objective%。还是有绿皮兽在继续轰击这个可怜的城镇，使用拼凑的攻城武器。你决定最好的行动方案是侧翼包抄野蛮人并攻击他们的攻城机械。}",
    "stage": 1
  },
  {
    "ID": 293407961,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_48.png[/img]{你走近了包围着的地精，看到了一个独特的身影站在他们的队伍之中。那是一个萨满。你告诉你的队员为之做好充分准备。 | 一个独特的身影在地精中脱颖而出。你看到它用那可怕的语言发出命令。这个污秽的东西被奇怪的植物缠绕着，并佩戴着动物骨头的项链。%SPEECH_ON%那是一个萨满。%SPEECH_OFF% %randombrother%加入了我们的一方说道。%SPEECH_ON%我会提醒其他人的。%SPEECH_OFF% | %randombrother%从侦查中返回。他分享了一个消息，即有一个地精萨满在入侵的绿皮兽人组内。那个人似乎相当恼火。%SPEECH_ON%我喜欢杀掉这些地精，但这次他们会给我们带来真正的头疼。%SPEECH_OFF%}",
    "stage": 1
  },
  {
    "ID": 293407984,
