[
  ...
  {
    "ID": 293408041,
    "key": "[img]gfx/ui/events/%illustration%.png[/img]{%holysite% has fallen to the southerners. One sellsword shakes his head.%SPEECH_ON%Well. I suspect they'll be all over the place shinin' or shittin'.%SPEECH_OFF%Indeed. With the sacred tracts lost, there'll be n",
    ...
    "translation": "[img]gfx/ui/events/%illustration%.png[/img]{%holysite%已落入南方人手中。一名佣兵摇了摇头。%SPEECH_ON%好吧。我估计他们很快就会到处耀武扬威或拉屎撒尿了。%SPEECH_OFF%确实。随着圣地失守，再回去找%employer%已经毫无意义——除非你想去看另一种“神圣景象”}",
    "stage": 5,
  ...
  {
    "ID": 293408044,
    "key": "[img]gfx/ui/events/event_45.png[/img]{%employer% is found surrounded by a congress of holy men, each seemingly more knowledgeable than the last about the intent and desires of the old gods. But there is a clear line of thought arrowing through the convers",
  ...
  {
    "ID": 293408045,
    "key": "[img]gfx/ui/events/%illustration%.png[/img]{The southerners have posted themselves in and around %holysite%. With time on their side, they've erected a sturdy defense, but nothing the %companyname% can't handle. You draw out your sword and prepare your me",
    ...
    "translation": "[img]gfx/ui/events/%illustration%.png[/img]{南方人已在%holysite%内外驻扎下来。得益于充裕的时间，他们构筑了坚固的防御，但这对于%companyname%来说根本不算什么。你拔出剑，命令手下准备进攻。}",
    "stage": 5,
  ...
  {
    "ID": 293408047,
    "key": "[img]gfx/ui/events/event_164.png[/img]{The battle is over, but a golden gleam in the distance catches your eye. As you stare at the horizon, a troop of southerners appears, their bright appearance no doubt meant to be seen. It's a counter-attack! | As you",
    ...
    "translation": "[img]gfx/ui/events/event_164.png[/img]{战斗已经结束，但远处一道闪耀的金光吸引了你的目光。当你凝视地平线时，一队南方士兵出现了，他们光鲜的装扮无疑是为了彰显声势。是反击部队！ | 正当你收剑入鞘时，%randombrother%大喊起来。他指向地平线。一列南方士兵正在逼近，他们的盔甲闪闪发光，步伐嚣张跋扈。这些反攻者刻意张扬而来，无疑志在必得…….}",
    "stage": 5,
  ...
  {
    "ID": 293408049,
    "key": "[img]gfx/ui/events/event_78.png[/img]{%holysite% is already under siege by men carrying %employerfaction%'s banner. As you come closer, a man meets you half way. He raises his hand and then puts it to his belt.%SPEECH_ON%I got word they were sending a mer",
    ...
    "translation": "[img]gfx/ui/events/event_78.png[/img]{%holysite%已被高举%employerfaction%旗帜的部队围困。当你靠近时，一名男子在半路迎上了你。他抬起手，然后按在腰带上。%SPEECH_ON%我接到消息说他们会派些佣兵过来，看来就是你了。是%companyname%对吧？我是%commander%，%employer%手下的一名军官。我将与你们一同清剿这些沙漠鼠辈。我担心，想必你也是，如果我们不立即完成这项任务，旧神会惩罚我们所有人。%SPEECH_OFF%他吐了口唾沫，用手抹过饱经风霜的脸。%SPEECH_ON%好吧。让旧神看清我们的本色，我们将以最正义的方式宰了这些乡巴佬。%SPEECH_OFF% | %holysite%已被高举%employerfaction%旗帜的部队围困。领头者上前大声说道。%SPEECH_ON%%companyname%，我是%commander%，%employer%麾下野战军的指挥官。我是来加入你们的，或者该说你们将加入我，一同前往%holysite%，将那些南方渣滓从圣地的每一寸土地上彻底抹除。因为旧神注视着我们所有人，即便是你们这样的佣兵也不例外，而今日的失败必将使我们万劫不复。%SPEECH_OFF%好吧。你只想确定，不管有无援军，%employer%是否都会全额支付报酬。 | %holysite%已被高举%employerfaction%旗帜的部队围困。看起来像是神职人员和士兵的混合队伍，率领部队的军官挥舞着他的剑，随即迅速指向%holysite%。%SPEECH_ON%那些南方马屁精要么自己滚蛋，要么我们就用手中的钢刃送他们去见旧神的地狱。在这件事上没有其他选择。来吧，佣兵们！%SPEECH_OFF%看来%companyname%这次行动会得到一些援助，尽管你仍期望能拿到全额的报酬。}",
    "stage": 5,
  ...
  {
    "ID": 293408063,
    "key": "[img]gfx/ui/events/event_164.png[/img]{The southerners' approach is ever steady.%SPEECH_ON%Roaches, they just never end.%SPEECH_OFF%You look over to see %randombrother% shaking his head. He lifts up his boot and flicks a bug off the toe. He puts his foot ",
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_134.png[/img]{当%holysite%映入眼帘时，一个看起来与你惊人相似的男子走了过来。他身边带着一个财务官和几个佣兵。%SPEECH_ON%晚上好，队长。我是%mercenarycompany%的%mercenary%。我和你一样，来这片土地是为了赚取克朗。我敢打赌，那个满脑肥油的贵族给你们的条件相当优厚。这样如何，你付我%pay%克朗，我就在这场小行动中助你一臂之力？除非，你想让我去为对面那边提供服务。%SPEECH_OFF% | 一群人向你走来，其中一人的步态和体格都与你相似到古怪的程度。他自称是%mercenary%，%mercenarycompany%的队长。%SPEECH_ON%我原以为%employer%会派他的正规军来夺回圣地。队长，实不相瞒，最初帮那些沙丘疯子占领这座神圣纪念碑的人就是我。不过，只要%pay%克朗，我很乐意帮你们夺回来。同为佣兵，你肯定明白这对各方都是笔好买卖。%SPEECH_OFF%}",
    "stage": 5,
  ...
  {
    "ID": 293408070,
    "key": "[img]gfx/ui/events/event_04.png[/img]{%townname%'s priory is flush with more peasants than you've ever seen before. %employer% is outside on the steps and greets you with a hand to your shoulder.%SPEECH_ON%Welcome back, sellsword. You might be a slight gi",
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_134.png[/img]{%SPEECH_START%真遗憾。%SPEECH_OFF%%mercenary%说着，迅速退回到%mercenarycompany%的队列中。他一路后退，直接融入了防守%holysite%的南方士兵阵线。他双臂张开摆动，仿佛在逆流游泳。%SPEECH_ON%我是说，真他妈遗憾！好吧，%companyname%的队长，就让咱们瞧瞧哪边请到了更强的佣兵，好吗？%SPEECH_OFF%这名佣兵拔出了武器，他身后%holysite%的南方士兵们也纷纷亮出兵刃。自然地，你也拔出了武器。是时候战斗了。 | %SPEECH_ON%行，行，我明白了。好吧。我本来也没抱太大期望。毕竟，我也是个雇佣兵。而现在……%SPEECH_OFF%他步步后退，与自己的战团会合，而他的战团则与守护%holysite%的南方士兵们融为一体。%SPEECH_ON%眼下看来，南方人才是出价更高的主顾。%SPEECH_OFF%}",
    "stage": 5,
