[
  {
    ...
    "translation": "[img]gfx/ui/events/event_20.png[/img]{过了段时间，特使出来了。 你问他有遇到什么麻烦吗，他说没有。是时候回去找 %employer%。 | 门打开了，特使从中走出。 他让你带他回家。 | 挺快特使就出来了。 他告诉你他办完事了而且他需要回去找 %employer%。 | %envoy% 匆忙回到你边上。 他告诉你，他需要尽快回去找 %employer%。 | 特使回来时他说谈的很顺利，而且你需要尽快把他带回 %employer%。}",
    "stage": 1
  },
  {
    "ID": 293408829,
  ...
  },
  {
    ...
    "translation": "当你能白拿克朗时为什么要流血呢？ 我们成交。",
    "stage": 1
  },
  {
    "ID": 293408831,
  ...
  },
  {
    ...
    "translation": "直到使者%envoy_title% %envoy%完成为止。",
    "stage": 1,
    "context": "'Wait around ' + this.Contract.m.Destination.getName() + ' until %envoy% %envoy_title% is done'"
  },
  {
  ...
  },
  {
    ...
    "translation": "{终于，我们出发！ | 你怎么花了这么长时间？}",
    "stage": 1
  },
  {
    "ID": 293408854,
  ...
  },
  {
    ...
    "translation": "{你得去别的地方找保镖了。 | 这不是我们要找的工作。}",
    "stage": 1
  },
  {
    "ID": 293408861,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_50.png[/img]{你一只手将特使推到身后同时另一只手拔出了你的剑。 神秘人点头并缓慢地藏到了他自己的阵线后。%SPEECH_ON%这很遗憾，但我依然有个生意要做。 I'm sure you understand.%SPEECH_OFF% | 神秘人张开一只手，手指卷起好似要把特使从你身边卷走。 与之相对，你将特使推到了你的战线后。 神秘人马上点了个头。%SPEECH_ON%可以理解。但不可行。 我们都有我们各自的雇主，佣兵。 你肯定，和我一样，都是忠诚的。 让我们中活下来的人去领取那些将信心交给我们的人的报酬吧。%SPEECH_OFF% | 特使向你哀求，但你告诉他闭嘴然后转身面向了杀手们。%SPEECH_ON%特使要站着离开这里。%SPEECH_OFF%点了点头，神秘人直接躲到了他的战线后。%SPEECH_ON%我理解。生意就是生意，那么现在，事必须被办完。%SPEECH_OFF%他的手下走上前来，拔出他们的剑。}",
    "stage": 1
  },
  {
    "ID": 293408864,
