[
  ...
  },
  {
    ...
    "translation": "负债者",
    "stage": 1,
    "context": "this.World.FactionManager.getFaction(nearest_nomads.getFaction()).spawnEntity(tile, 'Indebted', False, this.Const.World.Spawn.Slaves, 90 * this.Contract.getDifficultyMult() * this.Contract.getScaledDifficultyMult())"
  },
  {
    "ID": 293410017,
