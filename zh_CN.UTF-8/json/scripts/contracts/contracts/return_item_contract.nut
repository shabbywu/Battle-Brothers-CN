[
  ...
  },
  {
    ...
    "translation": "没能归还被盗的 ",
    "stage": 1,
    "context": "'Failed to return stolen ' + this.Flags.get('Item')"
  },
  {
    "ID": 293409789,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_22.png[/img]{战斗结束，你从敌人手中取回了 %itemLower% 并准备回去找 %employer%。他显然会很高兴看到你成功返回！ | 那些偷了 %itemLower% 的小偷都死了，而且你找到了它。%employer% 对你的工作成果肯定会很开心。 | 好，你找到了那些为偷窃 %itemLower% 负责的小偷并解决了他们。 现在你只需要把 %itemLower% 交回 %employer%的手上收取报酬！ | 战斗结束了而且 %itemLower% 很轻易的就在你的敌人尸体间找到了。 你应该把它还给 %employer% 拿取你应得的报酬！}",
    "stage": 1
  },
  {
    "ID": 293409800,
  ...
  },
  {
    ...
    "translation": "归还被盗的 ",
    "stage": 1,
    "context": "'Returned stolen ' + this.Flags.get('Item')"
  },
  {
    "ID": 293409806,
    "key": "Return %item% to %townname%",
    "original": "Return %item% to %townname%",
    "translation": "归还%item%给%townname%。",
    "stage": 1
  },
  {
    "ID": 293409807,
  ...
  },
  {
    ...
    "translation": "沿着附近的踪迹跟踪，离 %townname%",
    "stage": 1
  },
  {
    "ID": 293409812,
