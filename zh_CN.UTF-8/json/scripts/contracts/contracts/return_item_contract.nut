[
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_80.png[/img]{是强盗们！跟你的雇主猜的一样。他们看起来很害怕，或许是知道%employer%雇人花的钱将化成怒火降临在他们身上。 | 啊，这些小偷再普通不过 —— 只不过是一群流浪汉和强盗。当你命令你的手下攻击时，他们也拿起了武器。 | 一伙强盗拖着你雇主的财物游荡是被你撞了个正着。他们似乎对你能找到这里有些意外，不打算浪费口舌，他们拿起了武器，而你命令%companyname%发起冲锋。}",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_22.png[/img]{战斗结束，你从敌人手中夺回了%itemLower%并准备回去找%employer%。他看到你的成功一定会很高兴！ | 那些偷走%itemLower%的人都死了，谢天谢地你能找到物品本身。%employer%对你的工作成果肯定会很开心。 | 好，你找到了那些为偷窃%itemLower%负责的小偷并解决了他们。现在你只需要把%itemLower%交回%employer%的手上并收取报酬！ | 战斗结束了而且%itemLower%很轻易就在你敌人的尸体间找到了。你应该把它还给%employer%以获取你应得的报酬！}",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "沿着%townname%附近的踪迹前进",
    "stage": 5,
