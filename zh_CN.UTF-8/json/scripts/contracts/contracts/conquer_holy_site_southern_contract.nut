[
    ...
    {
        "key": "[img]gfx/ui/events/event_164.png[/img]{As you near %holysite%, a man rises seemingly from the ground itself. Startled, you draw your weapon but the man reveals himself to be a camouflaged commander of %employer%.%SPEECH_ON%Easy, Crownling, you'll have your coin yet. The Vizier's birds have told my outfit of your approach and I must say, you're a bit late. I know this isn't your war, but, well, I suppose this is no time for admonishment. Let us reclaim the holy lands for the Gilder, and may both our paths forward be ever gilded by his shine.%SPEECH_OFF% | %holysite% is in sight when a man seemingly appears out of the ground. He asks if you are the commander of the %companyname%, and a slight pause must have given him the answer for he speaks straight away.%SPEECH_ON%Yes, of course you are. I am %commander%, lieutenant of %employer%. The Vizier's birds told you may come. You may be chasing coin, Crownling, but if we are victorious today the Gilder will shine brightly upon your morrow's path!%SPEECH_OFF%}",
    ...
    {
        "key": "[img]gfx/ui/events/event_134.png[/img]{As %holysite% draws into view, a man who looks almost eerily similar to you approaches. He's got a paymaster and a couple of sellswords at his side.%SPEECH_ON%Evenin', captain. I am %mercenary% of the %mercenarycompany%. I came to these lands in search of crown, just as you have. Now, I wager the Vizier wetted his pen in a sound contract for you and your men, but what say you pay me %pay% crowns and I'll help you in this little endeavor?%SPEECH_OFF% | You are approached by a group of men, one of which whose gait and constitution alike seem strangely reminiscent to your own. He announces himself as %mercenary%, captain of the %mercenarycompany%.%SPEECH_ON%I thought the Vizier might send his professional army to see to the holy site's change of hands. I will admit to you, captain, that I helped the northerners take over this prestigious monument in the first place. However, for %pay% crowns, I'm willing to help your side take it back. As a fellow mercenary, I'm sure you can see how this would be a good deal for all involved.%SPEECH_OFF%}",
    ...
    {
        "key": "[img]gfx/ui/events/%illustration%.png[/img]{As the Vizier believed, the northerners have taken up positions in and around %holysite%. Most of the riffraff religious folk have long since departed, leaving only the %companyname% and the opposing force. You draw out your sword and order the men to make the attack.}",
