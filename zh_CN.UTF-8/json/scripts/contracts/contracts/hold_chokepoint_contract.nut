[
    ...
    {
        "key": "[img]gfx/ui/events/event_78.png[/img]{%randombrother% yells out and you rush to the walls. Arrayed across the field is a contingent of heavily armed northerners. Perhaps they have learned that is the %companyname% standing before them and they wish to take the matter a mite more seriously. Not that extra caution will save them. There's only one result of facing down the %companyname% and you can't help but offer an inviting grin at the approaching assault.}",
    ...
    {
        "key": "[img]gfx/ui/events/event_78.png[/img]{The northerners approach once more. They march through the corpses like bream through brine, a dark knot of men and material, darkly and silhouetted in the bloody mud which you've made of the earth they dare trespass over. Rats already pecking at the dead scatter every which way and the buzzards take flight. You raise your arm and order the men to prepare for what is hopefully the final battle.}",
    ...
    },
    {
        ...
        "original": " Company",
        "translation": " 战团",
        "context": "candidates.this.Math.rand(0, candidates.len() - 1).getName() + ' Company'"
    },
    {
        "key": "[img]gfx/ui/events/event_167.png[/img]{The %companyname% are almost starting to look like the men they were when you first hired them: downtrodden and beaten by the world. But all this time with the company has made them better men. Despite the exhaustion, there is no tiring out training, there is no wearing down prestige, there is no taxing renown. When it comes, the %companyname% will be ready for the next assault.}",
    ...
    {
        "key": "[img]gfx/ui/events/event_164.png[/img]{The northerners approach once more. They march through the corpses like bream through brine, a dark knot of men and material, darkly and silhouetted in the bloody mud which you've made of the earth they dared trespass over. Just as you raise your arms to give your men command, more men appear on the horizon. Your heart sinks for a moment, until you realize they are flying %employer%'s colors! The Vizier's men have arrived!}",
    ...
    {
        "key": "[img]gfx/ui/events/event_167.png[/img]{The first attack has been repelled. You briefly consider using the corpses to plug holes in the walls, but you've no interest inviting rats and their pestilence to the field. With a snap order, you have the bodies heaped in a pile outside the walls and then have the men prepare for the next assault.}",
    ...
    {
        "key": "[img]gfx/ui/events/event_168.png[/img]{With bodies piling up, flies buzzing about, and buzzards circling the air in great black clouds, it appears the northerners have had enough. A horn sounds off with a defeated pitter-patter of bleats and the men lower their arms and turn back from whence they came. At the same time, a scout arrives from the south saying that %employer%'s troops will soon arrive. It seems you are safe to return to your employer.}",
