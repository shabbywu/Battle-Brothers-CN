[
    ...
    {
        "key": "[img]gfx/ui/events/event_71.png[/img]{The battle is over and %location% has been secured. It's time to return to %employer%. | You look over the battle and nod, happy to still have a head upon your shoulders with which to nod with. Time to return to %employer%. | As rough a fight as there can be, you gather the men and ready a return to %employer%. | The fight over, you assess the scene and ready a report. %employer% will want to know everything which has happened here.}",
