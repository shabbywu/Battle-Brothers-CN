[
    ...
    },
    {
        ...
        "translation": "未能保护",
        "context": "'Failed to protect ' + this.Contract.getEmployer().getName() + \"'s firstborn son\""
    },
    {
        "key": " is afraid",
        "original": " is afraid",
        "translation": "是害怕的",
        "context": "this.Contract.m.Dude.getName() + ' is afraid'"
    },
    {
        "key": "Betrayed ",
        "original": "Betrayed ",
        "translation": "背叛了",
        "context": "'Betrayed ' + this.Contract.getEmployer().getName() + ' and struck a deal with witches'"
    },
    {
    ...
    },
    {
        ...
        "translation": "{想要对付这种敌人，你必须给我们丰厚的报酬。 | 用满满一袋克朗来说服我这是值得的。 | 我希望能得到丰厚的报酬来和这样的敌人作战。}",
        "context": ""
    },
    {
        "key": "To arms!",
    ...
    },
    {
        ...
        "translation": "[img]gfx/ui/events/event_106.png[/img]{女巫笑了。%SPEECH_ON%一个没有强身健体去闯荡世界的男人什么都不是。 给，佣兵。 请不要浪费它。%SPEECH_OFF%她把瓶子丢给你。 半空中旋转着，它泛起青绿色的光芒照在土地上，每一抹微光都从未播种的泥土中催生出一朵小花。 你抓住了玻璃瓶。 它在你手中震动着，你筋骨的疼痛慢慢消去，就好像你的拳头一直都在沉睡而你就是不知道。 当你抬起头寻求解释时女巫们已经走了。 只剩下一声哭号，从遥远的距离回想着然而完全无法辨别有多远。 无疑是源于 %employer% 初生子的死。}",
        "context": ""
    }
]