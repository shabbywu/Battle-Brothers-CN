[
  ...
  {
    "ID": 293403680,
    "key": "]+15[/color] Resolve and [color=",
    "original": "]+15[/color] Resolve and [color=",
    "translation": "]+15[/color] 决心和 [color=",
    "stage": 1,
  ...
  {
    "ID": 293403683,
    "key": "]+5[/color] Melee and Ranged Defense when fighting the undead.",
    "original": "]+5[/color] Melee and Ranged Defense when fighting the undead.",
    "translation": "]+5[/color] 近战和远程防御(与亡灵战斗时)",
    "stage": 1,
    "context": "this.m.OathBoonText = 'Your men have [color=' + this.Const.UI.Color.PositiveValue + ']+15[/color] Resolve and [color=' + this.Const.UI.Color.PositiveValue + ']+10[/color] Melee and Ranged Skill, and [color=' + this.Const.UI.Color.PositiveValue + ']+5[/color] Melee and Ranged Defense when fighting the undead.'"
  },
  {
    "ID": 293403684,
    "key": "You gain extra Renown for slaying the undead (",
    "original": "You gain extra Renown for slaying the undead (",
    "translation": "誓言目标: 击杀目标的亡灵数目(",
    "stage": 1,
    "context": "return 'You gain extra Renown for slaying the undead (' + this.getBonusObjectiveProgress() + '/' + this.getBonusObjectiveGoal() + ').';"
  },
  {
    "ID": 293403685,
  ...
  {
    "ID": 293403687,
    "key": "\"Beware the evil which has stolen into this realm. Set aside the worldly matters and dedicate oneself to putting our dead to rest once and for all. No man deserves to walk twice across this darkened land.\" - Young Anselm",
    ...
    "translation": "“当心那些潜入这个世界的邪恶。抛开世俗事物，全身心投入到彻底安息我们的死者之中。没有人应该在这片黑暗土地上走上第二遍路。” ——年轻的安瑟姆",
    "stage": 1,
  ...
  {
    "ID": 293403690,
    "key": "]-5[/color] Melee and Ranged Defense when fighting any other foe.",
    "original": "]-5[/color] Melee and Ranged Defense when fighting any other foe.",
    "translation": "]-5[/color] 近战和远程防御(与其他敌人战斗时)。",
    "stage": 1,
    "context": "this.m.OathBurdenText = 'Your men have [color=' + this.Const.UI.Color.NegativeValue + ']-10[/color] Resolve and [color=' + this.Const.UI.Color.NegativeValue + ']-5[/color] Melee and Ranged Skill, and [color=' + this.Const.UI.Color.NegativeValue + ']-5[/color] Melee and Ranged Defense when fighting any other foe.'"
  }
]
