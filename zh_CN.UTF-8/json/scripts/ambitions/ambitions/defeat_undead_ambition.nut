[
  ...
  },
  {
    ...
    "translation": "[img]gfx/ui/events/event_73.png[/img]穿着破布的尸体蹒跚而行。很快，每个村庄的墓地都开始把吐出这些东西，而这还只是开始。古代军团觉醒了。 他们从不疲倦，从不畏惧，像一台冰冷的机器一样前进，永远向前。他们曾经征服过已知的世界，如果不是因为一群紧密团结的雇佣军，他们很可能再次征服这个世界。%SPEECH_ON%行军的死人，穿着没见过的盔甲行走的骨头，来自这个世界之外的东西…我从没想过我会看到这样的恐怖。但是我们赢了！%SPEECH_OFF%%bravest_brother%高举武器，好像要发出冲锋的信号。%SPEECH_ON%%companyname%连这样的敌人都能战胜！现在谁还敢跟我们作对？%SPEECH_OFF%还有谁？",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "击败亡灵天灾！每完成一次针对他们的合约，每摧毁一支军队或一处营地，都将使你们离拯救人类世界更近。",
    "stage": 1,
