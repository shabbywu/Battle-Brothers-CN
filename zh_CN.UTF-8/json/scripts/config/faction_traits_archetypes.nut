[
    ...
    {
        "key": "Most members of the house of %noblehousename% live secluded behind thick doors and barred windows and some of them have not been seen for years. Rumor has it that their noble blood is plagued with madness and insanity but no ordinary man dares to utter such claims in fear of their vengeance. Other noble houses mainly avoid contact to house %noblehousename% as guests may be greeted with open arms as well as crossbow bolts.",
    ...
    {
        "key": "Wealth is sought by many, but the highly reputable traders of house %noblehousename% are the best when it comes to striking profitable bargains. Bound by ancestral ties to the renown of their forefathers they uphold honesty and integrity as their family values.",
    ...
    {
        "key": "Disdained for their ruthlessness, brutality and greed, house %noblehousename% has little interaction with other noble families. Their captains and soldiers are known for raiding trade caravans, outlying farms and small settlements from their fortress of %factionfortressname%. A life is not worth much in the realm of house %noblehousename% and many a mercenary on the look for a quick coin only found a quick end here.",
    ...
    {
        "key": "House %noblehousename% claims to have roots in the time when man first claimed this land, and the first king ruled all men. They are but one of many noble houses now, but proud of their long history and with ambitions to continue writing history. As their renown and their resources dwindle in the now, they are said to finance expeditions in an attempt to unearth long lost treasures from the past, in sunken cities and places long forgotten.",
    ...
    {
        "key": "Trading and haggling can be just as fierce as fighting a war, and the house of %noblehousename% is a true master of cunning bargains. Rumor has it that many a profitable deal made by house %noblehousename% is not only based on honest trading but also bribery, extortion and deception. The family resides in the pompous region capitol of %factionfortressname%, but despite their unmeasurable riches they are known to be notoriously close-fisted.",
    ...
    {
        "key": "House %noblehousename% is hated by many but feared by even more. A number of small and big uprisings have been put down with fire and sword and the %noblehousename% henchmen are known to have eyes in every shady corner and ears in every wall. The family's ancestral home of %factionfortressname% is swarming with armed guards, sniffing wardogs and bulky mercenaries to protect their paranoid leaders.",
