[
    ...
    },
    {
        ...
        "translation": "]-5[/color] 在非对抗绿皮族时的近战防御能力",
        "context": "'[color=' + this.Const.UI.Color.NegativeValue + ']-5[/color] Melee Defense when not fighting greenskins'"
    },
    {
        ...
        "context": "'[color=' + this.Const.UI.Color.NegativeValue + ']-5[/color] Ranged Skill when not fighting greenskins'"
    },
    {
        "key": "]+15[/color] Resolve when fighting greenskins",
        "original": "]+15[/color] Resolve when fighting greenskins",
        "translation": "]+15[/color] 意志（对抗绿皮）",
        "context": "'[color=' + this.Const.UI.Color.PositiveValue + ']+15[/color] Resolve when fighting greenskins'"
    },
    {
    ...
    },
    {
        ...
        "translation": "该角色已经宣誓复仇，发誓要与困扰人类的绿皮族作战。",
    ...
    },
    {
        ...
        "context": "'[color=' + this.Const.UI.Color.NegativeValue + ']-5[/color] Ranged Defense when not fighting greenskins'"
    },
    {
    ...
    },
    {
        ...
        "translation": "]-10[/color] 意志（未对抗绿皮族）",
        "context": "'[color=' + this.Const.UI.Color.NegativeValue + ']-10[/color] Resolve when not fighting greenskins'"
    },
    {
