[
  ...
  },
  {
    ...
    "translation": "茫然了",
    "stage": 5,
    "context": "this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(user) + ' struck a hit that leaves ' + this.Const.UI.getColorizedEntityName(_targetEntity) + ' dazed')"
  },
  {
    "ID": 293420412,
    "key": "Sling Stone",
  ...
  },
  {
    ...
    "translation": "用你投石杖向目标抛射石块。准确度随着距离急剧下降。无法在陷入近战时使用。",
    "stage": 1,
