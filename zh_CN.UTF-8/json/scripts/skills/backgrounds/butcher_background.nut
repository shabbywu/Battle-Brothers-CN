[
  ...
  },
  {
    ...
    "translation": "雇佣兵的工作是一项血腥的事业，这也许就是为什么像%name%这样的屠夫在其中会感到很自在。虽然他是个出色的战士，但你听说他与队伍内的战犬仍有矛盾，曾多次被抓到试图宰杀它们。最终，如果不是没办法的话，战团给了这个人一只可爱的小狗养。从你所知道的情况来看，这小家伙的发光无辜眼睛把这个讨厌狗的人变成了爱狗之人。现在每当有战犬受到伤害时，他就会进入一种无法满足的血腥狂热状态，而他的小杂种狗已经成长为战团中最凶猛的野兽！",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "屠夫%name%最终离开了这个每况愈下的战团。他加入了另一支队伍，但在屠杀他们的一只战犬时被抓了个正着。显然，他一直在给雇佣兵们提供他们所有那些“失踪”的杂种狗的狗肉。他们对于这个消息并不满意，于是剥去了屠夫的衣服，并将他喂给了野兽。",
    "stage": 5,
