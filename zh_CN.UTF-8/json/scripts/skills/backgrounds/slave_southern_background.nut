[
  ...
  },
  {
    ...
    "translation": "你将%name%买作战团的负债者，且在你退出后，他继续留在%companyname%的队伍里。这个雇佣兵团的问题的消息已经逐渐传开，但目前这个负债者的状况却杳无音讯。考虑到这个世界的运作方式，他可能被放在最前线充当炮灰，或者甚至被出售以回收利润。不管怎么说，这个世界上佣兵还是负债者都不轻松，而这个人不幸两者都是。",
    "stage": 1,
