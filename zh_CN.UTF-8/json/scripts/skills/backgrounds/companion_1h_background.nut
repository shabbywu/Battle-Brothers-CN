[
  ...
  },
  {
    ...
    "translation": "%name% 不是个爱吹牛的家伙，但是他有权这么做。 {他曾救过 %2h% 和 %ranged%。 | 他曾从兽人的邪恶锁链下解救了你。 | 如果不是这个人，你已经在酒吧被刺客杀了。 | 要不是 %name%的盾牌帮你挡住，一支射歪的弩箭差点了命中了你的眼珠子。 | 他曾经用盾牌和两条强壮的腿把两个人从悬崖上推下来。 | 他从父亲那里学会了如何战斗，他父亲是一位诸多著名战役中的先锋。 | 他牺牲了他家的传家宝－一块木头和镶钉铁做的旧盾牌－救了你的命。 | 他的英雄气概始终如一，一次他从酒吧火灾中救出了一个醉酒的 %2h%。 | 面对一大群地精，他用他的盾牌和力量在他们的防线上开了一个洞，为 %2h% 和 %ranged% 打开了一条路，将他们全部杀死。} 凭借着回旋腾挪和盾牌挥舞，他躲开了各种危险。 尽管十分得镇静，你发现 %name%在盾墙中的位置无可替代。",
    "stage": 1,
