[
  ...
  },
  {
    ...
    "translation": "格斗家%name%在战团显然即将解散并有可能会让留下来的人都丧命时离开了。他回归拳击比赛，在每周残酷的比赛中挣扎了好几年。随着年龄的增长，他的下巴消失了，速度和力量也跟着消失。他只能打假赛，故意倒下，在没倒成的时候被暴打。最终，没有人再想和他比赛了。一个贵族向他提出了高价佣金，让他和一只熊搏斗，绝望的%name%接受了这个挑战。当这场“战斗”结束时，这个格斗家死掉了，面目全非，被凶猛的野兽在泥泞中拖着，而醉酒的贵族们欢呼雀跃着。",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "像%name%这样的格斗家只用拳头就很危险，并且证明了自己在使用武器时同样可怕。在你离开%companyname%之前，你和这个斗士谈过他是否要留下。他说他不想重返拳击比赛，并和你握手，感谢你给他这个机会。据你最后得知，战团选择他在一场一对一的比赛中与一支竞争的雇佣兵团队决定赔偿差异。他在第一轮就赢了。",
    "stage": 5,
