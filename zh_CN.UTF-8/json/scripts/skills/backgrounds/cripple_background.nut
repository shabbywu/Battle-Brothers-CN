[
  {
    ...
    "translation": "惊人的是一个像%name%这样的人居然活了下来，但是这个残废最终从%companyname%退休时拥有了相当可观的一笔财富。如今他经营着一个孤儿院，花他自己的钱来帮助世界上那些受伤和被遗弃的孩子们。不过，或许这个孤儿院只是一种廉价劳动力的掩护，毕竟如今谁也无法确定。",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "对于一个残废来说，唯一迅速的是他在真正的战斗中可预见的死亡。",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "当你离开%companyname%时，有一件事你几乎可以肯定：那个可怜的残废%name%不会活得太久。尽管困难重重，他还是活了下来。实际上，他活得足够久到退休，尽管离开时所拥有的财富与刚加入时没什么两样。你不知道他后来过得怎么样，但他现在肯定已经死了。确定，对吧？",
    "stage": 5,
