[
  {
    ...
    "translation": "你很惊讶像 %name% 这样的瘸子居然能生存下来，并从 %companyname% 退役时带着一大笔克朗。如今他经营了一家孤儿院，用这些克朗帮助这个世界上那些破碎和被遗弃的孩子们，或者这只是廉价劳动力的掩护，这些日子我们再也不能确定了。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "关于瘸子唯一快速的东西就是他在一场真正的战斗中预期的死亡速度。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "当你离开了%companyname%战团后，有一件事情你几乎是肯定的：那个该死的跛子 %name% 不会活得太久。然而，尽管机会渺茫，他还是活了下来，活得足够久以至于自行退役，尽管他离开前的克朗数量与入伍时相差无几。你不知道他现在过着什么样的生活，但肯定他已经死了。肯定了，对吧？",
    "stage": 1,
