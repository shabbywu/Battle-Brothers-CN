[
    {
        "key": "With the downfall of the %companyname% written plainly on the wall, %name% the refugee split with the company. He used what scant crowns he had left to purchase a set of shoes and returned to his destroyed home to try and rebuild it. While walking home, an illiterate wildman murdered him and ate the shoes.",
        ...
        "translation": "由于%companyname%的崩溃已经板上钉钉，难民 %name% 离开了战团。他用手头仅剩的一点克朗购买了一双鞋并返回他被毁的家园试图重建它。在回家的路上，一个不识字的野人杀了他并吃了那双鞋。",
    ...
    },
    {
        ...
        "translation": "难民缺乏为家园而战的信念，他们现在已经习惯了漫长而疲惫的旅行。",
    ...
    },
    {
        ...
        "translation": "难民%name%表现出了非常自然的战斗技能，然而他最终退出了%companyname%。有传言称他回到了家乡，现在正在用他所有的克朗帮助家乡重建。",
    ...
    },
    {
        "key": "Runsfar",
        "original": "Runsfar",
        "translation": "润斯法尔(Runsfar)",
        "context": ""
    },
    {
        "key": "Refugee",
        "original": "Refugee",
        "translation": "难民(Refugee)",
