[
  ...
  },
  {
    ...
    "translation": "退役士兵(Retired Soldier)",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "因为厌倦了所有的战斗，%name% 离开了急剧衰落的 %companyname%，并在树林里建造了一间小屋。不幸的是，流浪汉袭击了他。传言称他被发现在地上流血，周围有六个死人。最后一个站着的人是一个紧张的、垮掉的男孩，男孩手里拿着一把剑正指着那个垂死的老人。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "%name% 再次退役了，这次不再是当兵。他从%companyname%里离开了，在树林里搭建了一间小屋，享受着平静宁静的生活，尽可能远离所有战斗。",
    "stage": 1,
