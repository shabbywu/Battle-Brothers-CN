[
  {
    ...
    "translation": "%name% 代替他该杀的贵族进入战团。这样的协议看起来十分奇怪，让你观察刺客许多天。但他所做的一切都是为了%companyname%而战，而且打得出色。据你最后所知，刺客已经离开了战团，从此没有音讯。你去查看那该死的贵族，想知道刺客是否完成了任务，但发现他还活得好好的。最终这是一个奇怪的巧合。",
    "stage": 1,
