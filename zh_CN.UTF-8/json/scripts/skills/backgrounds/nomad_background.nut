[
    ...
    },
    {
        ...
        "translation": "沙漠之虐(the Desert Scourge)",
        "context": ""
    },
    {
        "key": "the Waylayer",
        "original": "the Waylayer",
        "translation": "伏击者(the Waylayer)",
        "context": ""
    },
    {
        "key": "the Hyena",
    ...
    {
        "key": "The nomad %name% left the %companyname% a few months after yourself. He apparently traveled south and now leads what they're calling the 'City on Legs,' a huge band of peoples that roam the deserts. It is apparently so rich and successful a society that the Viziers worry their own people will flock to it.",
    ...
    },
    {
        ...
        "translation": "任何一个在沙漠中生存的游牧民都会有战斗方面的专长。",
