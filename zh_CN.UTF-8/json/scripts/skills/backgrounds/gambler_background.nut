[
  {
    ...
    "translation": "赌徒往往比牌桌上的对手反应更迅速、决心更坚定。",
    "stage": 5,
  ...
  {
    "ID": 293420982,
    "key": "%name% the gambler retired from the declining company and returned to his gambling ways. He quickly acquired great debts he could not pay. You saw him begging on a street corner with one of his hands missing and gaps in his teeth. You dropped a few crowns",
    ...
    "translation": "%name%这个赌徒从每况愈下的战团退休了，又回到了他的赌博生活中。他很快就欠下了无法偿还的巨额债务。你看到他在街角乞讨，一只手不见了，牙齿上有裂缝。你往他的罐子里扔了几个克朗，说了几句话，但他没有认出你来。",
    "stage": 5,
  ...
  {
    "ID": 293420983,
    "key": "It was perhaps a risk to take a gambler like %name% into your ranks. Now, many days later it's obvious you made the right choice. Last you heard, he was still with the company and uses his earnings to enrich his habits. Rumor has it that, through all his ",
    ...
    "translation": "让%name%这样的赌徒加入你的队伍也许是有风险的。现在，许多天过去了，很明显你的选择是正确的。你最后听到的消息是，他还在战团里，并且用他的收入来丰富他的生活习惯。有传言说他通过一系列胜利已经秘密地成为世界上最富有的人之一。你认为这是一派胡言，但令人惊讶的是，许多市长在赌博问题上变得突然松懈了……",
    "stage": 5,
