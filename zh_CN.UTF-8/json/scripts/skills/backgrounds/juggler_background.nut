[
  ...
  },
  {
    ...
    "translation": "杂耍者%name%退出了战斗。他在{南部地区 | 北部地区 | 东部地区 | 西部地区}为一个花哨的贵族表演时，某个节目出了差错。有传言说他因为这个失误被从塔楼上扔下，但你不愿意相信这个说法。",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "杂耍者%name%拿出他所有做佣兵挣的钱，成立了一个巡回剧团。你最后听到的消息是，他建立了一座剧院，每月上演一部新剧！",
    "stage": 5,
