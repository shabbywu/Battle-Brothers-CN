[
  ...
  },
  {
    ...
    "translation": "矿工%name%从此没有回到矿井里，谢天谢地。如果有一种生活比为生存而战还要糟糕，那么挖掘山脉谋生绝对算是其中之一！据说这位矿工在海边建了一座房子，度过了余生，悠闲地钓鱼晒日出之类的事情。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "矿工习惯于体力劳动，但多年来呼吸矿井里的粉尘可能对他的健康造成了损害。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "如果说有一种生活比当佣兵更加艰苦，那便是当矿工。可悲的是，%name% 重新回到了那个生活，回到矿井里去开采金属和矿石，来填满一些富人的口袋。最近的一次地震导致了许多类似的矿井坍塌。你不知道老兄是否安然无恙，但情况看起来非常严峻。",
    "stage": 1,
