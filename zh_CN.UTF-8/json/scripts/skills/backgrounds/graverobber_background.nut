[
  ...
  },
  {
    ...
    "translation": "一个像掘墓贼%name%这样的人来到了战团，帮助他逃脱他最卑鄙不道德的错误，还有什么比为金钱杀人更好的方式呢？不幸的是，%companyname%逐渐瓦解了。你得知%name%最终离开了战团，并加入了一家类似的竞争对手。你不确定他现在在哪里，也不确定是否应该为他的背叛感到受辱或理解其背后的原因。毕竟，生意只是生意。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "像%name%这样的盗墓贼在这个世界上并不是最受欢迎的人，但你只需要他做一名出色的佣兵，他就可以胜任了。在你离开这个行业后，你得知这位盗墓贼留了下来。据你所知，他现在是该战团的教官，帮助新手们适应。",
    "stage": 1,
