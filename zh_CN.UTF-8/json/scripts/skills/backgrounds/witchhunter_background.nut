[
  {
    ...
    "translation": "{%name% 有一天出现在 %townname% 中，有人说是应要于 {地方议会 | 当地牧师}. | %name% 名声显赫，会在不寻常的事情发生的地方出现，并在夜晚最黑暗的时候外出行动。 | 作为一个沉默寡言、冷酷无情的人，%name% 有点让周围的人感到不舒服甚至害怕。 | %name% 这个名字在很多村子里都很出名，因为他走遍了最需要他的才能的地方。} {他自称是女巫猎人。 他拥有各种各样的异国工具，在让人们痛苦地忏悔他们与魔鬼和魔鬼在可怕的折磨下的罪恶联系方面有着丰富的经验。 | 他自称是一个女巫猎人，但只有迷信的傻瓜才会相信这一点，并相信他的荒谬故事。 | 他自称是女巫猎人，他声称看过了遥远之地的恐怖，会让不够格的人发疯。 | 在他到达 %townname% 后，有传言说他正在寻找恶魔崇拜者和午夜的生物，但没有人知道他此行的真正目的是什么。 | 在 %townname% 中，他因为杀死了一位老妇人并被扔进地牢。 事实证明，这名妇女是绑架和杀害3名婴儿的罪魁祸首，所以他又被释放了。 | 一连几个晚上，他都坐在 %townname%的酒吧里，像一只在上面盘旋的猛禽一样，默默地研究着每一位顾客，他的弩就在手边。 居民们对此感到不满，但他们不敢接近他。} {现在大多数当地人都希望 %name% 早日离开，并乐于看到他加入一个旅行佣兵团。 | 看来他的任务现在已经完成了，所以 %name% 以佣兵的身份提供服务。 | 很明显 %name% 不容易被吓到，而且他也知道如何使用弩。 因此，当他加入一家佣兵的战团时，没有人感到惊讶。 | 现在，一个佣兵战团将是他完成个人任务，打击来超越这个世界的邪恶的工手段。 | 大多数人都很乐意摆脱他。}",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "女巫猎人往往有一定的军事经验，即使面对难以言喻的恐怖，他们的决心也往往不会被打破。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "%name% 猎巫人最终听到了北方村庄传播邪恶的消息。他离开了 %companyname% 并一直在树立火刑堆，烧掉那些可怕的女巫。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "北方不断扩散的邪恶气息吸引了战团的猎物人 %name%。他带上了木桩、奇怪液体的小瓶和大量引线后出发。一个月后，一个农民在北方荒野发现他，他的眼睛被掏空，嘴巴被缝起来。他的胸前印有一个奇怪的符号，当农民碰它的时候，两个人都爆炸了。",
    "stage": 1,
  ...
  },
  {
    ...
    "stage": 1,
    "context": "'[color=' + this.Const.UI.Color.PositiveValue + ']+20[/color] Resolve at morale checks against fear, panic or mind control effects'"
  },
  {
    "ID": 293421391,
    "key": "Witchhunter",
    "original": "Witchhunter",
    "translation": "猎巫人(Witchhunter)",
    "stage": 1,
