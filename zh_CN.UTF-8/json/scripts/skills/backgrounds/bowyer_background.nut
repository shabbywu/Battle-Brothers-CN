[
    ...
    },
    {
        ...
        "translation": "在一次骑士比武大会上，一个年轻男孩使用了一支形状奇特但制作完美的弓。他瞄准时手有些颤抖，但箭矢一旦放出就不再摇晃。在他赢得比赛后，你询问这个男孩从哪里得到了这么了不起的弓。他说是一位名叫 %name% 的弓匠打造的。显然，他以制作全国最好的弓而著称！",
    ...
    },
    {
        ...
        "translation": "你离开了 %companyname% 后，曾寄信询问箭术师 %name% 的近况。你得到消息称，他已经发现了一种手工制作最好的弓的方法，并没有将这个秘密告诉战团，而是离开了战团开始自己的事业。然而他走不远，就死在了这里 {北 | 南 | 西 | 东} 边的一条泥泞的路上，有传言说他身上被刺了十几支箭，具有讽刺意味。",
    ...
    },
    {
        ...
        "translation": "弓匠对如何使用他们以前制造的远程武器有一定的了解。",
