[
  ...
  },
  {
    ...
    "translation": "一个优秀的石匠习惯于体力劳动和研究学习提高他的手艺。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "%companyname%在你离开后继续遭受损失。越来越多的兄弟离开了战团，其中不少人返回从前的手艺。其中石匠%name%也不例外。遗憾的是，所有经历的战斗摧毁了他剩下的稳定性。手不停颤，他再也不能像从前那样刻石了。据最后一次听到的消息，他已经成为一名搬运工，而不是石匠了。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "石匠有着自己独特的召唤，尤其是一声声完美切割石块的声音和不可思议的高塔，让我们对眼前的景象产生了怀疑。%name%这个石匠回归了他的老本行，在使用%companyname%赚到的所有钱后，他开始了一家有口碑的生意，以其建造的能够在冬天保暖，在夏天保凉的石制房间而闻名。",
    "stage": 1,
