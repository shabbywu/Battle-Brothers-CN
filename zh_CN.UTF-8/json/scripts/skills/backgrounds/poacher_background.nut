[
  {
    ...
    "translation": "前偷猎者%name%最终攒够了足够的钱离开了%companyname%。你得知他找到了一块山地，为当地贵族工作。具有讽刺意味的是，他的工作是狩猎偷猎者。",
    "stage": 5,
  ...
  },
  {
    ...
    "translation": "不再为了这么少的克朗冒生命危险，前盗猎者%name%放弃了佣兵的生活，回到树林里非法猎鹿。曾经有位贵族向你提供了一大包克朗让你特意去追捕这个人。你拒绝了这个提议，但是无可避免地：他的生命已经进入倒计时。",
    "stage": 5,
