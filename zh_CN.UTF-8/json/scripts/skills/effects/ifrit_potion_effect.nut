[
    ...
    },
    {
        ...
        "context": "\"This character's skin is hard and stone-like, granting [color=\" + this.Const.UI.Color.PositiveValue + ']25[/color] points of natural armor'"
    },
    {
        "key": "This character's skin has mutated and now forms hard, rock-like patches that are much hardier and difficult to puncture. When broken, these patches will gradually reform in what is apparently a rather painful, uncomfortable process. You should tell them to stop picking at that scab.",
