[
    {
        ...
        "translation": "当处于高压情境时，该角色的变异身体会产生一种黏滑、粘稠的物质，并开始过度出汗。在这种状态下，他们逃脱任何网或陷阱都会更加容易。记得带一条毛巾。",
    ...
    {
        "key": "Hyperactive Sweat Glands",
        "original": "Hyperactive Sweat Glands",
        "translation": "多汗症(Hyperactive Sweat Glands)",
        "context": "this.m.Name = 'Hyperactive Sweat Glands'"
    }
]