[
  {
    ...
    "translation": "随着战团荣耀的战斗标准的临近，这个角色感到不得不向前推进，并在表情上吐弃着危险。",
    "stage": 1,
  ...
  },
  {
    ...
    "translation": "为了战团！",
    "stage": 1,
    "context": "this.m.Name = 'For the company!'"
  },
  {
    "ID": 293421418,
    "key": "[/color] Resolve",
    ...
    "stage": 1,
    "context": "text = '[color=' + this.Const.UI.Color.PositiveValue + ']+' + bonus + '[/color] Resolve'"
  }
]
