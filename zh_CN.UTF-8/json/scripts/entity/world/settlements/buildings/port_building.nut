[
  {
    ...
    "translation": "一个港口，可以让你订船到大陆的其他地方",
    "stage": 1
  },
  {
    ...
    "translation": "{一艘快速船 | 一艘结实的船 | 一艘商船 | 一艘龙头船 | 一艘小船 | 一艘商贸船 | 一艘客船 | 一艘当地渔船 | 一艘吱吱作响的老船}名叫'%shipname%'，{可以接受您的战团搭乘到%destname% | 正巧开往%destname%并可接受您的战团搭乘 | 即将启航，可以安全、快速地到达%destname% | 可以提供比在陆地上旅行更快到达%destname%的方式 | 可以将你送到%destname%，以换取一份满钱囊的克朗}。",
    "stage": 1,
