[
  {
    ...
    "translation": "地精",
    "stage": 1,
    "context": "this.getFaction().spawnEntity(this.m.Start.getTile(), 'Goblins', False, this.Const.World.Spawn.GoblinRaiders, this.Math.rand(70, 130) * this.getScaledDifficultyMult())"
  },
  {
    "ID": 293417315,
