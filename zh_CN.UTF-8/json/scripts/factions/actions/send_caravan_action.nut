[
  {
    ...
    "translation": "来自一个贸易商队",
    "stage": 1,
    "context": "'A trading caravan from ' + this.m.Start.getName() + ' that is transporting all manner of goods between settlements.'"
  },
  {
    "key": "Trading Caravan",
