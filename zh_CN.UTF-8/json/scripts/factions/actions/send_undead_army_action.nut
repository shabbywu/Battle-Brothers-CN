[
  {
    ...
    "translation": "亡灵",
    "stage": 1,
    "context": "this.World.FactionManager.getFactionOfType(this.Const.FactionType.Undead).spawnEntity(myTile, 'Undead', False, this.Const.World.Spawn.UndeadScourge, this.Math.rand(80, 120) * this.getScaledDifficultyMult())"
  },
  {
    "ID": 293417396,
