[
    ...
    {
        "key": "]+4[/color] Resolve",
        "original": "]+4[/color] Resolve",
        "translation": "]+4[/color] 决心",
        "context": "'[color=' + this.Const.UI.Color.PositiveValue + ']+4[/color] Resolve'"
    },
    {
        ...
        "translation": "这个项链是从多个食尸鬼身上取来的雕饰制作而成，穿戴它的人会被视作针对野蛮凶兽的老手，而且不容易畏惧。",
