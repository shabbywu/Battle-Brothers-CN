[
    ...
    {
        "key": "{%name% is like many deserters. You can see the spirit of a fighter in him, but the heart for it is withering. It doesn't make him a coward, as many assume deserters to be, but instead simply a man who may need change. Hopefully the coin of mercenary work can provide it.}",
    ...
    {
        "key": "{A fine fighter by any judgment, %name% simply hated the low pay of being a soldier in the army. His pursuit of the sellsword's life makes sense. Though he is quite flighty, you believe his transient sense of allegiance will be buffered by a steady flow of good coin.}",
